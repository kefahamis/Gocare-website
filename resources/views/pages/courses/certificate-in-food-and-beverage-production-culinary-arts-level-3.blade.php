      ...
      <div class="course-hero-content">
        <div class="hero-text" style="padding-left: 32px;">
          ...
          <nav class="ph-breadcrumb" aria-label="Breadcrumb">
            <a href="../">Home</a><i data-lucide="chevron-right"></i><a href="../courses">Courses</a><i data-lucide="chevron-right"></i><span>Certificate in Food &amp; Beverage Production (Culinary Arts) &ndash; Level 3</span>
          </nav>
