...
<body>
  ...
  <div class="success-overlay" id="successOverlay">
    <div class="success-modal">
      ...
      <p>Your Application ID:</p>
       <div class="app-id" id="applicationReference">Pending</div>
  ...
  <footer id="contactSection" class="footer">
    ...
    <div class="footer-top">
      ...
      <div class="footer-col">
        ...
        <ul>
          ...
          <li><a href="industrial-attachment">Industrial &amp; Field Attachment</a></li><li><a href="student-support-services">Student Support Services</a></li><li><a href="modes-of-study">Modes of Study</a></li><li><a href="/#">Students Portal</a></li><li><a href="admissions#overview">Admissions</a></li><li><a href="apply">Apply Online</a></li>
    ...
    <div class="footer-bottom">
      ...
      <div class="footer-bottom-links"><a href="/#">Privacy Policy</a> <span class="divider">|</span> <a href="/#">Terms of Service</a></div>
    </div>
  </footer>
  <script>
    ...
    function submitApplication() {
      ...
      fetch('{{ route('applications.store') }}', {
        ...
        body: JSON.stringify({ application: 'GoCare Training Institute application' })
      }).then(response => response.json()).then(result => {
        document.getElementById('successOverlay').classList.add('show');
        document.querySelector('#successOverlay h2').textContent = 'Application Submitted';
        document.querySelector('#successOverlay p').textContent = `Reference: ${result.reference}`;
        document.getElementById('applicationReference').textContent = result.reference;
        lucide.createIcons();
      }).catch(() => {
