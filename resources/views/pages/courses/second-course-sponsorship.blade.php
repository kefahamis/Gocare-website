...
<head>
  ...
  <title>Second Course Sponsorship &ndash; GoCare Training Institute</title>
...
<nav class="nav" id="mainNav">
  ...
  <header class="course-hero">
    <div class="hero-visual">
      <img loading="lazy" decoding="async" src="../images/slider-four.jpg" alt="Additional Course Sponsorship">
    </div>
    <div class="wrap">
      <div class="course-hero-content">
        <div class="hero-text" style="padding-left: 32px;">
          <span class="course-badge"><i data-lucide="gift"></i> Student Benefit &ndash; Ongoing Admission &amp; Registration</span>
          <nav class="ph-breadcrumb" aria-label="Breadcrumb">
            <a href="../index">Home</a><i data-lucide="chevron-right"></i><a href="../courses">Courses</a><i data-lucide="chevron-right"></i><span>Additional Course Sponsorship</span>
          </nav>
          <h1>Additional Course <span style="color:var(--o)">Sponsorship</span></h1>
          <p class="intro">Enroll for any of our TVET CDACC/NITA courses and get an equivalent sponsorship for additional internationally accredited training and certification &ndash; at no extra tuition cost.</p>
          <div class="ph-btns">
  ...
  <style>
    ...
    .scs-page { background: #f4f6f9; }

    /* Stats bar */
    .scs-stats { background: var(--dark); padding: 20px 0; }
    .scs-stats-inner { display: flex; justify-content: center; gap: 0; }
    .scs-stat { text-align: center; padding: 0 40px; border-right: 1px solid rgba(255,255,255,0.15); }
    .scs-stat:last-child { border-right: none; }
    .scs-stat-num { display: block; font-size: 1.8rem; font-weight: 800; color: var(--o); line-height: 1; }
    .scs-stat-lbl { display: block; font-size: 0.78rem; color: rgba(255,255,255,0.7); text-transform: uppercase; letter-spacing: 0.5px; margin-top: 4px; }

    /* Main layout */
    .scs-body { padding: 52px 0 64px; }
    .scs-grid { display: grid; grid-template-columns: 1fr 340px; gap: 32px; align-items: start; }

    /* Section titles */
    .scs-section-label { display: inline-flex; align-items: center; gap: 8px; background: rgba(237,116,36,0.1); color: var(--o); font-size: 0.78rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1.5px; padding: 5px 14px; border-radius: 50px; margin-bottom: 12px; }

    /* Eligible courses card */
    .scs-courses-card { background: #fff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.07); margin-bottom: 24px; }
    .scs-courses-head { background: linear-gradient(135deg, var(--o) 0%, #c05500 100%); padding: 28px 32px; }
    .scs-courses-head h2 { color: #fff; font-size: 1.25rem; font-weight: 800; margin: 0 0 4px; }
    .scs-courses-head p { color: rgba(255,255,255,0.85); font-size: 0.9rem; margin: 0; }
    .scs-courses-list { padding: 8px 0; }
    .scs-course-item { display: flex; align-items: center; gap: 16px; padding: 18px 32px; border-bottom: 1px solid #f0f0f0; transition: background 0.2s; }
    .scs-course-item:last-child { border-bottom: none; }
    .scs-course-item:hover { background: #fdf6f0; }
    a.scs-course-item { text-decoration: none; color: inherit; cursor: pointer; }
    .scs-course-icon { width: 44px; height: 44px; border-radius: 12px; background: rgba(237,116,36,0.1); display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
    .scs-course-icon i { color: var(--o); width: 20px; height: 20px; }
    .scs-course-info strong { display: block; color: var(--dark); font-weight: 700; font-size: 0.97rem; }
    .scs-course-info span { color: #888; font-size: 0.82rem; }
    .scs-course-badge { margin-left: auto; background: rgba(237,116,36,0.1); color: var(--o); font-size: 0.75rem; font-weight: 700; padding: 4px 12px; border-radius: 50px; white-space: nowrap; }

    /* How it works steps */
    .scs-steps-card { background: #fff; border-radius: 16px; padding: 32px; box-shadow: 0 4px 24px rgba(0,0,0,0.07); margin-bottom: 24px; }
    .scs-steps { display: flex; flex-direction: column; gap: 0; margin-top: 20px; }
    .scs-step { display: flex; gap: 20px; align-items: flex-start; position: relative; padding-bottom: 28px; }
    .scs-step:last-child { padding-bottom: 0; }
    .scs-step::before { content: ''; position: absolute; left: 19px; top: 44px; bottom: 0; width: 2px; background: #f0f0f0; }
    .scs-step:last-child::before { display: none; }
    .scs-step-num { width: 40px; height: 40px; border-radius: 50%; background: var(--o); color: #fff; font-weight: 800; font-size: 1rem; display: flex; align-items: center; justify-content: center; flex-shrink: 0; position: relative; z-index: 1; }
    .scs-step-body strong { display: block; color: var(--dark); font-weight: 700; font-size: 1rem; margin-bottom: 4px; }
    .scs-step-body p { color: #666; font-size: 0.9rem; line-height: 1.6; margin: 0; }

    /* Key offer banner */
    .scs-offer-banner { background: linear-gradient(135deg, var(--dark) 0%, #2d0d4e 100%); border-radius: 16px; padding: 32px; position: relative; overflow: hidden; margin-bottom: 24px; }
    .scs-offer-banner::before { content: ''; position: absolute; top: -40px; right: -40px; width: 180px; height: 180px; background: var(--o); opacity: 0.12; border-radius: 50%; }
    .scs-offer-banner::after { content: ''; position: absolute; bottom: -60px; left: -30px; width: 220px; height: 220px; background: var(--o); opacity: 0.07; border-radius: 50%; }
    .scs-offer-tag { display: inline-flex; align-items: center; gap: 6px; background: var(--o); color: #fff; font-size: 0.78rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; padding: 5px 14px; border-radius: 50px; margin-bottom: 14px; position: relative; z-index: 1; }
    .scs-offer-banner h3 { color: #fff; font-size: 1.3rem; font-weight: 800; margin: 0 0 10px; position: relative; z-index: 1; }
    .scs-offer-banner p { color: rgba(255,255,255,0.85); line-height: 1.7; margin: 0 0 20px; position: relative; z-index: 1; font-size: 0.95rem; }
    .scs-offer-highlight { background: rgba(255,255,255,0.1); border-left: 4px solid var(--o); border-radius: 0 10px 10px 0; padding: 16px 20px; position: relative; z-index: 1; }
    .scs-offer-highlight strong { color: var(--o); display: block; font-size: 0.82rem; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 4px; }
    .scs-offer-highlight p { color: #fff; margin: 0; font-size: 0.92rem; }

    /* Tagline strip */
    .scs-tagline { background: linear-gradient(90deg, var(--o), #c05500); border-radius: 12px; padding: 18px 28px; text-align: center; }
    .scs-tagline p { color: #fff; font-weight: 800; font-size: 1rem; text-transform: uppercase; letter-spacing: 1.5px; margin: 0; }

    /* Sidebar */
    .scs-apply-card { background: #fff; border-radius: 16px; padding: 28px; box-shadow: 0 4px 24px rgba(0,0,0,0.08); border-top: 5px solid var(--o); margin-bottom: 20px; }
    .scs-admission-badge { display: inline-flex; align-items: center; gap: 6px; background: rgba(237,116,36,0.1); color: var(--o); font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; padding: 5px 12px; border-radius: 50px; margin-bottom: 16px; }
    .scs-admission-badge span { width: 6px; height: 6px; background: var(--o); border-radius: 50%; animation: pulse 1.5s infinite; }
    @keyframes pulse { 0%,100%{opacity:1;} 50%{opacity:0.3;} }
    .scs-apply-card h3 { color: var(--dark); font-size: 1.25rem; font-weight: 800; margin: 0 0 6px; }
    .scs-apply-card p { color: #777; font-size: 0.88rem; line-height: 1.6; margin: 0 0 20px; }
    .scs-btn-primary { display: block; background: var(--o); color: #fff; text-align: center; padding: 14px; border-radius: 50px; font-weight: 700; font-size: 0.95rem; text-decoration: none; margin-bottom: 10px; transition: background 0.2s; }
    .scs-btn-primary:hover { background: #c05500; color: #fff; }
    .scs-btn-outline { display: block; border: 2px solid var(--o); color: var(--o); text-align: center; padding: 12px; border-radius: 50px; font-weight: 700; font-size: 0.95rem; text-decoration: none; transition: all 0.2s; }
    .scs-btn-outline:hover { background: var(--o); color: #fff; }

    .scs-contact-card { background: var(--dark); border-radius: 16px; padding: 24px 28px; }
    .scs-contact-card h4 { color: rgba(255,255,255,0.6); font-size: 0.75rem; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600; margin: 0 0 16px; }
    .scs-contact-item { display: flex; gap: 12px; align-items: flex-start; padding: 10px 0; border-bottom: 1px solid rgba(255,255,255,0.08); }
    .scs-contact-item:last-child { border-bottom: none; padding-bottom: 0; }
    .scs-contact-item i { color: var(--o); flex-shrink: 0; width: 16px; height: 16px; margin-top: 2px; }
    .scs-contact-item span { color: rgba(255,255,255,0.85); font-size: 0.88rem; line-height: 1.5; }
    .scs-contact-item small { color: rgba(255,255,255,0.5); font-size: 0.78rem; }

    @media (max-width: 900px) {
      .scs-grid { grid-template-columns: 1fr; }
      .scs-stats-inner { flex-wrap: wrap; gap: 20px; }
      .scs-stat { border-right: none; }
    }
  </style>
  ...
  <div class="scs-page">
    ...
    <div class="scs-stats">
      <div class="wrap">
        <div class="scs-stats-inner">
          <div class="scs-stat">
            <span class="scs-stat-num">2</span>
            <span class="scs-stat-lbl">Qualifications</span>
          </div>
          <div class="scs-stat">
            <span class="scs-stat-num">1</span>
            <span class="scs-stat-lbl">Tuition Fee</span>
          </div>
          <div class="scs-stat">
            <span class="scs-stat-num">3</span>
            <span class="scs-stat-lbl">Eligible Courses</span>
          </div>
          <div class="scs-stat">
            <span class="scs-stat-num">100%</span>
            <span class="scs-stat-lbl">Sponsored 2nd Course</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="wrap">
        <div class="scs-grid">
          ...
          <div>
            ...
            <!-- Eligible Courses -->
            <div class="scs-courses-card">
              <div class="scs-courses-head">
                <h2>Eligible Courses for Sponsorship</h2>
                <p>Enroll in any of these TVET CDACC / NITA programmes to qualify</p>
              </div>
              <div class="scs-courses-list">
                <a class="scs-course-item" href="certificate-in-healthcare-support-services-level-5-certified-nursing-assistant">
                  <div class="scs-course-icon"><i data-lucide="stethoscope"></i></div>
                  <div class="scs-course-info">
                    <strong>Healthcare Support Services</strong>
                    <span>Certificate &ndash; Level 5</span>
                  </div>
                  <span class="scs-course-badge">Level 5</span>
                </a>
                <a class="scs-course-item" href="certificate-in-caregiving-level-4">
                  <div class="scs-course-icon"><i data-lucide="heart-handshake"></i></div>
                  <div class="scs-course-info">
                    <strong>Caregiving</strong>
                    <span>Certificate &ndash; Level II / 4</span>
                  </div>
                  <span class="scs-course-badge">Level II/4</span>
                </a>
                <a class="scs-course-item" href="certificate-in-home-based-care-support-level-3">
                  <div class="scs-course-icon"><i data-lucide="home"></i></div>
                  <div class="scs-course-info">
                    <strong>Home-Based Care Support</strong>
                    <span>Certificate &ndash; Level 3</span>
                  </div>
                  <span class="scs-course-badge">Level 3</span>
                </a>
              </div>
            </div>

            <!-- How it works -->
            <div class="scs-steps-card">
              <div class="scs-section-label"><i data-lucide="list-ordered" style="width:14px;height:14px;"></i> How It Works</div>
              <h2 style="color:var(--dark); font-size:1.3rem; font-weight:800; margin:0;">Simple. Straightforward. Rewarding.</h2>
              <div class="scs-steps">
                <div class="scs-step">
                  <div class="scs-step-num">1</div>
                  <div class="scs-step-body">
                    <strong>Enroll in a Primary Course</strong>
                    <p>Choose any of the three eligible TVET CDACC / NITA programmes and complete your registration.</p>
                  </div>
                </div>
                <div class="scs-step">
                  <div class="scs-step-num">2</div>
                  <div class="scs-step-body">
                    <strong>GoCare Sponsors Your Second Course</strong>
                    <p>We fully train you in an internationally accredited complementary programme &ndash; at zero extra tuition cost to you.</p>
                  </div>
                </div>
                <div class="scs-step">
                  <div class="scs-step-num">3</div>
                  <div class="scs-step-body">
                    <strong>Graduate with Two Qualifications</strong>
                    <p>You leave with both a national TVET CDACC certificate and an internationally recognised certification &ndash; boosting your global employability.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <!-- Key offer -->
            <div class="scs-offer-banner">
              <div class="scs-offer-tag"><i data-lucide="gift" style="width:13px;height:13px;"></i> Special Offer</div>
              <h3>Second Course Sponsorship</h3>
              <p>Enroll for any of these <strong style="color:#fff;">TVET CDACC / NITA Courses</strong> and receive an equivalent sponsorship for <strong style="color:var(--o);">additional internationally accredited training and certification.</strong></p>
              <div class="scs-offer-highlight">
                <strong>You Pay for One Course</strong>
                <p>We sponsor and train you in the second complimentary course free of charge &ndash; and you acquire an internationally recognised certification!</p>
              </div>
            </div>
          ...
          <div>
            ...
            <!-- Apply card -->
            <div class="scs-apply-card">
              <div class="scs-admission-badge"><span></span> Ongoing Admission &amp; Registration</div>
              <h3>Apply Now</h3>
              <p>Don't miss this exclusive opportunity to earn two internationally recognised qualifications for the price of one.</p>
              <a href="../apply" class="scs-btn-primary">Apply Now &rarr;</a>
              <a href="../contact" class="scs-btn-outline">Check Eligibility</a>
            </div>

            <!-- Contact card -->
            <div class="scs-contact-card">
              <h4>Get in Touch</h4>
              <div class="scs-contact-item">
                <i data-lucide="phone"></i>
                <span>0703 115 502 / 0745 220 344 / 0745 229 485</span>
              </div>
              <div class="scs-contact-item">
                <i data-lucide="globe"></i>
                <span>www.gocareinstitute.ac.ke</span>
              </div>
              <div class="scs-contact-item">
                <i data-lucide="map-pin"></i>
                <span>Nairobi City Campus | Thika Road / Ruiru Campus<br><small>Hostels &amp; Accommodation Available</small></span>
              </div>
            </div>
