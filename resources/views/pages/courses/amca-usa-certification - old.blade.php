...
<style>
  ...
  /* -- MAIN CONTENT -- */
  .icp-body {
    background: linear-gradient(160deg, #f5efe8 0%, #ede4f5 100%);
    padding: 60px 40px;
  }
  .icp-body-inner { max-width: 1200px; margin: 0 auto; display: grid; grid-template-columns: 1fr 1fr; gap: 24px; }
  ...
  /* Global Recognition card &ndash; with image */
  .icp-recognition-img {
    width: 100%; height: 160px; object-fit: cover; border-radius: 8px; margin-bottom: 14px;
  }
  .icp-recognition-caption {
    font-size: 0.95rem; color: #334155; font-weight: 500; text-align: center;
  }

  /* Career Advancement card */
  .icp-career-body { display: flex; align-items: center; gap: 16px; }
  .icp-career-body .icp-career-icon { font-size: 2.8rem; }
  .icp-career-body p { font-size: 1.05rem; color: #1a0a2e; font-weight: 600; line-height: 1.5; margin: 0; }

  /* Application Process card */
  .icp-app-body { display: flex; align-items: center; gap: 16px; }
  .icp-app-body p { font-size: 1.05rem; color: #1a0a2e; font-weight: 600; line-height: 1.5; margin: 0; }
  ...
  .icp-stories-inner { max-width: 1200px; margin: 0 auto; }
  .icp-stories h2 {
    font-family: 'Outfit', sans-serif; font-size: 1.5rem; font-weight: 800;
    color: var(--dark); text-align: center; margin: 0 0 30px;
  }
  .icp-stories h2 span { color: var(--o); }
  .icp-stories-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 24px; }
  .icp-story-card { border-radius: 12px; overflow: hidden; position: relative; }
  .icp-story-card img { width: 100%; height: 220px; object-fit: cover; display: block; }
  .icp-story-caption {
  ...
  @media (max-width: 900px) {
    ...
    .icp-body-inner { grid-template-columns: 1fr; }
    .icp-stories-grid { grid-template-columns: 1fr; }
    .icp-partner-logo { min-width: 150px; border-right: none; border-bottom: 1px solid #e2e8f0; }
    .icp-hero-inner { padding: 100px 20px 50px; }
    .icp-body { padding: 40px 20px; }
    .icp-stories { padding: 40px 20px; }
  ...
  /* Career icon: two Lucide icons side by side */
  .icp-career-icon {
    display: flex; align-items: center; gap: 8px;
    background: linear-gradient(135deg, #ec7424, #4a1a6d);
    border-radius: 16px; padding: 16px 20px;
  }
  .icp-career-icon .lucide {
    width: 36px; height: 36px; stroke: #fff; stroke-width: 1.8;
  }

  /* Application process icon */
  .icp-app-icon {
    display: flex; align-items: center; gap: 8px;
    background: linear-gradient(135deg, #4a1a6d, #ec7424);
    border-radius: 16px; padding: 16px 20px;
  }
  .icp-app-icon .lucide {
    width: 36px; height: 36px; stroke: #fff; stroke-width: 1.8;
...
<!-- -- MAIN CONTENT GRID -- -->
<div class="icp-body">
  <div class="icp-body-inner">

    <!-- Certification Programs -->
    <div class="icp-card">
      <h3><i data-lucide="award"></i> Certification Programs</h3>
      <ul class="icp-checklist">
        ...
        <li>
          <div class="icp-check"><svg viewBox="0 0 24 24" fill="none"><polyline points="20 6 9 17 4 12"/></svg></div>
          <a href="aha-emergency-care-programs" style="color: inherit; text-decoration: none;">AHA Emergency Care Programs</a>
        </li>
        <li>
          <div class="icp-check"><svg viewBox="0 0 24 24" fill="none"><polyline points="20 6 9 17 4 12"/></svg></div>
          <a href="basic-life-support-bls" style="color: inherit; text-decoration: none;">Basic Life Support (BLS)</a>
        </li>
        <li>
          <div class="icp-check"><svg viewBox="0 0 24 24" fill="none"><polyline points="20 6 9 17 4 12"/></svg></div>
          <a href="advanced-cardiac-life-support-acls" style="color: inherit; text-decoration: none;">Advanced Cardiac Life Support (ACLS)</a>
        </li>
        <li>
          <div class="icp-check"><svg viewBox="0 0 24 24" fill="none"><polyline points="20 6 9 17 4 12"/></svg></div>
          <a href="pediatric-advanced-life-support-pals" style="color: inherit; text-decoration: none;">Pediatric Advanced Life Support (PALS)</a>
        </li>
        <li>
          <div class="icp-check"><svg viewBox="0 0 24 24" fill="none"><polyline points="20 6 9 17 4 12"/></svg></div>
          <a href="heartsaver-first-aid" style="color: inherit; text-decoration: none;">Heartsaver First Aid CPR &amp; AED</a>
        </li>
      </ul>
    </div>
    ...
    <!-- Global Recognition -->
    <div class="icp-card">
      <h3><i data-lucide="globe"></i> Global Recognition</h3>
      <img loading="lazy" decoding="async" class="icp-recognition-img" src="../images/new-images/DSC05908.jpg" alt="Global Recognition">
      <p class="icp-recognition-caption">Accepted in USA, Canada, Europe, Middle East &amp; Asia</p>
    </div>

    <!-- Career Advancement -->
    <div class="icp-card">
      <h3><i data-lucide="trending-up"></i> Career Advancement</h3>
      <div class="icp-career-body">
        <div class="icp-career-icon">
          <i data-lucide="plane"></i>
          <i data-lucide="globe"></i>
        </div>
        <p>Opportunities for International Jobs &amp; Studies</p>
      </div>
    </div>

    <!-- Application Process -->
    <div class="icp-card">
      <h3><i data-lucide="clipboard-list"></i> Application Process</h3>
      <div class="icp-app-body">
        <div class="icp-app-icon">
          <i data-lucide="clipboard-list"></i>
          <i data-lucide="check-circle"></i>
        </div>
        <p>Register for Exams &amp; Training Modules</p>
      </div>
    </div>
...
<!-- -- SUCCESS STORIES -- -->
<div class="icp-stories">
  <div class="icp-stories-inner">
    <h2><span>Success</span> Stories</h2>
    <div class="icp-stories-grid">
      <div class="icp-story-card">
        <img loading="lazy" decoding="async" src="../images/new-images/c94b4897-1696-4de0-b063-e56fcd3e50a5.jpg" alt="From GoCare to Working in the UK">
        <div class="icp-story-caption">From GoCare to Working in the UK</div>
      </div>
      <div class="icp-story-card">
        <img loading="lazy" decoding="async" src="../images/new-images/1717177421087.jpg" alt="Certified Abroad and Thriving">
        <div class="icp-story-caption">Certified Abroad and Thriving</div>
      </div>
    </div>
  </div>
</div>
