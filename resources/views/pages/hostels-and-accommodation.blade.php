...
<head>
  ...
  <title>Hostels and Accommodation | GoCare Training Institute</title>
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;600;700&family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&family=Inter:wght@400;700&display=swap" rel="stylesheet">
...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hst-page { padding-top: 0; }
  .hst-hero { background: linear-gradient(135deg, var(--dark) 0%, #2d0f3c 60%, #1a0924 100%); padding: 100px 0 80px; text-align: center; position: relative; overflow: hidden; }
  .hst-hero::before { content: ''; position: absolute; inset: 0; background: radial-gradient(circle at 20% 50%, rgba(236,116,37,0.15) 0%, transparent 50%), radial-gradient(circle at 80% 30%, rgba(100,42,126,0.2) 0%, transparent 40%); pointer-events: none; }
  .hst-hero-inner { position: relative; z-index: 2; max-width: 800px; margin: 0 auto; padding: 0 20px; }
  .hst-hero-badge { display: inline-flex; align-items: center; gap: 8px; background: rgba(236,116,37,0.15); color: var(--o); padding: 8px 20px; border-radius: 50px; font-size: .85rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 24px; border: 1px solid rgba(236,116,37,0.25); }
  .hst-hero h1 { font-size: 3.2rem; font-weight: 800; color: #fff; line-height: 1.1; margin-bottom: 16px; }
  .hst-hero h1 span { color: var(--o); }
  .hst-hero-sub { display: flex; justify-content: center; flex-wrap: wrap; gap: 12px; margin-bottom: 24px; }
  .hst-hero-sub span { background: rgba(255,255,255,0.1); color: rgba(255,255,255,0.85); padding: 6px 16px; border-radius: 50px; font-size: .8rem; font-weight: 600; border: 1px solid rgba(255,255,255,0.15); }
  .hst-hero p { font-size: 1.1rem; color: rgba(255,255,255,0.75); max-width: 680px; margin: 0 auto; line-height: 1.7; }
  .hst-hero p strong { color: #fff; }
  .hst-section { padding: 80px 0; }
  .hst-wrap { max-width: 1200px; margin: 0 auto; padding: 0 20px; }
  .hst-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 28px; }
  .hst-card { background: #fff; border-radius: 16px; overflow: hidden; border: 1px solid #e2e8f0; transition: transform .25s, box-shadow .25s; position: relative; }
  .hst-card:hover { transform: translateY(-6px); box-shadow: 0 20px 40px rgba(74,26,109,0.12); }
  .hst-card::before { content: ''; position: absolute; top: 0; left: 0; right: 0; height: 4px; background: linear-gradient(90deg, var(--o), var(--p)); }
  .hst-card-head { padding: 28px 28px 0; display: flex; align-items: flex-start; gap: 16px; }
  .hst-card-icon { flex-shrink: 0; width: 48px; height: 48px; border-radius: 12px; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, rgba(236,116,37,0.1), rgba(100,42,126,0.1)); color: var(--o); }
  .hst-card-head h3 { font-size: 1.1rem; font-weight: 700; color: var(--dark); line-height: 1.3; }
  .hst-card-body { padding: 16px 28px 28px; }
  .hst-card-body p { font-size: .9rem; color: #64748b; line-height: 1.6; margin-bottom: 12px; }
  .hst-card-body ul { list-style: none; padding: 0; }
  .hst-card-body ul li { position: relative; padding-left: 24px; margin-bottom: 6px; font-size: .88rem; color: #475569; line-height: 1.5; }
  .hst-card-body ul li::before { content: ''; position: absolute; left: 0; top: 8px; width: 6px; height: 6px; border-radius: 50%; background: var(--o); }
  .hst-highlight { font-size: .9rem; font-weight: 700; color: var(--o); }
  .hst-ideal { background: #fff; padding: 80px 0; }
  .hst-ideal-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: center; }
  .hst-ideal h2 { font-size: 2.4rem; font-weight: 800; color: var(--dark); margin-bottom: 20px; }
  .hst-ideal-list { list-style: none; padding: 0; }
  .hst-ideal-list li { padding-left: 32px; margin-bottom: 16px; font-size: 1rem; color: #475569; line-height: 1.5; position: relative; }
  .hst-ideal-list li::before { content: '\2713'; position: absolute; left: 0; top: 0; color: var(--o); font-weight: 800; }
  .hst-cta { text-align: center; padding: 80px 20px; background: linear-gradient(135deg, var(--o) 0%, #d05d15 50%, #b84d0f 100%); position: relative; overflow: hidden; }
  .hst-cta::before { content: ''; position: absolute; inset: 0; background: radial-gradient(circle at 30% 20%, rgba(255,255,255,0.12) 0%, transparent 50%), radial-gradient(circle at 80% 80%, rgba(255,255,255,0.08) 0%, transparent 40%); pointer-events: none; }
  .hst-cta > * { position: relative; z-index: 2; }
  .hst-cta h2 { font-size: 2.2rem; font-weight: 800; color: #fff; margin-bottom: 16px; }
  .hst-cta p { font-size: 1.05rem; color: rgba(255,255,255,0.85); max-width: 600px; margin: 0 auto 12px; line-height: 1.6; }
  .hst-cta-tagline { font-size: 1.3rem !important; font-weight: 700 !important; color: #fff !important; margin-bottom: 32px !important; text-shadow: 0 2px 8px rgba(0,0,0,0.15); }
  .hst-cta-btn { display: inline-flex; align-items: center; gap: 10px; background: #fff; color: var(--o); padding: 16px 36px; border-radius: 50px; font-weight: 700; font-size: 1rem; box-shadow: 0 10px 30px rgba(0,0,0,0.15); transition: transform .2s, box-shadow .2s; }
  .hst-cta-btn:hover { transform: translateY(-3px); box-shadow: 0 15px 40px rgba(0,0,0,0.25); }
  @media (max-width: 1024px) { .hst-grid { grid-template-columns: repeat(2, 1fr); } .hst-ideal-grid { grid-template-columns: 1fr; } .hst-hero h1 { font-size: 2.6rem; } }
  @media (max-width: 768px) { .hst-hero { padding: 80px 0 60px; } .hst-hero h1 { font-size: 2rem; } .hst-section { padding: 60px 0; } .hst-grid { grid-template-columns: 1fr; } .hst-cta h2 { font-size: 1.8rem; } }
  @media (max-width: 480px) { .hst-hero h1 { font-size: 1.7rem; } .hst-card-head { padding: 20px 18px 0; } .hst-card-body { padding: 12px 18px 20px; } .hst-cta-btn { width: 100%; justify-content: center; } }
  .ha-strip { display:grid; grid-template-columns:1fr 1fr 1fr; height:260px; gap:6px; }
  .ha-strip img { width:100%; height:100%; object-fit:cover; display:block; }
  .ha-split { display:grid; grid-template-columns:1fr 1fr; border-radius:16px; overflow:hidden; border:1px solid #e2e8f0; margin:40px 0; }
  .ha-split-img img { width:100%; height:100%; object-fit:cover; min-height:280px; display:block; }
  .ha-split-body { padding:36px 32px; display:flex; flex-direction:column; justify-content:center; background:#fcf9f8; }
  .ha-split-body h3 { font-size:1.3rem; font-weight:800; color:#4a1a6d; margin-bottom:12px; }
  .ha-split-body p { font-size:.95rem; color:#475569; line-height:1.7; }
  @media(max-width:768px){ .ha-strip{grid-template-columns:1fr 1fr;height:180px;} .ha-strip img:last-child{display:none;} .ha-split{grid-template-columns:1fr;} }
</style>
<div class="hst-page">
    <!-- PAGE HERO -->
  <section class="ph">
    <div class="ph-bg">
      <img loading="eager" decoding="async" src="images/new-images/IMG_2063.jpg" alt="GoCare Hostel Room">
    </div>
    <div class="ph-overlay"></div>
    <div class="ph-inner">
      <div class="ph-content">
        <span class="ph-eyebrow"><i data-lucide="home"></i> Campus Life</span>
        <nav class="ph-breadcrumb" aria-label="Breadcrumb">
          <a href="/">Home</a><i data-lucide="chevron-right"></i><span>Accommodation</span>
        </nav>
        <h1>Hostels & <em>Accommodation</em></h1>
        <p>Safe, comfortable, and affordable student accommodation near our Nairobi campus &mdash; so you can focus entirely on your studies.</p>
        <div class="ph-btns">
  ...
  <section class="hst-section"><div class="hst-wrap"><div class="hst-section-header" style="text-align:center;margin-bottom:56px"><h2 style="font-size:2.4rem;font-weight:800;color:var(--dark);margin-bottom:12px">Why Students Love GoCare Hostels</h2><p style="font-size:1.05rem;color:#64748b;max-width:550px;margin:0 auto">Discover why our students feel right at home in our modern and secure campus hostels.</p></div><div class="hst-grid">
    <div class="hst-card"><div class="hst-card-head"><div class="hst-card-icon"><i data-lucide="shield-check" style="width:24px;height:24px"></i></div><h3>Safe &amp; Secure Environment</h3></div><div class="hst-card-body"><p>Your safety is our priority. Our hostels offer:</p><ul><li>24/7 security</li><li>Well-lit surroundings</li><li>Controlled access</li><li>A peaceful, student-friendly atmosphere</li></ul><p>Parents trust GoCare because we provide a secure and protected living environment.</p></div></div>
    <div class="hst-card"><div class="hst-card-head"><div class="hst-card-icon"><i data-lucide="bed" style="width:24px;height:24px"></i></div><h3>Modern, Clean &amp; Comfortable Rooms</h3></div><div class="hst-card-body"><p>Our hostels are designed to support a healthy and productive student lifestyle, with:</p><ul><li>Clean, well-maintained rooms</li><li>Comfortable beds</li><li>Adequate ventilation</li><li>Quiet study spaces</li><li>Reliable water supply</li></ul><p>Students enjoy a comfortable home-away-from-home experience.</p></div></div>
    <div class="hst-card"><div class="hst-card-head"><div class="hst-card-icon"><i data-lucide="map-pin" style="width:24px;height:24px"></i></div><h3>Convenient Location Near Campus</h3></div><div class="hst-card-body"><p>GoCare Training Institute hostels are located close to our campuses, making it easy for students to:</p><ul><li>Attend classes on time</li><li>Access labs and study areas</li><li>Participate in group work</li><li>Save on transport costs</li></ul><p>This convenience enhances academic performance and student wellbeing.</p></div></div>
    <div class="hst-card"><div class="hst-card-head"><div class="hst-card-icon"><i data-lucide="users" style="width:24px;height:24px"></i></div><h3>Supportive Student Community</h3></div><div class="hst-card-body"><p>Living in GoCare hostels allows students to:</p><ul><li>Build friendships</li><li>Study together</li><li>Share experiences</li><li>Support each other</li><li>Grow socially and academically</li></ul><p>Our hostels foster a positive, respectful, and inclusive community.</p></div></div>
    <div class="hst-card"><div class="hst-card-head"><div class="hst-card-icon"><i data-lucide="wallet" style="width:24px;height:24px"></i></div><h3>Affordable &amp; Flexible Options</h3></div><div class="hst-card-body"><p>GoCare Training Institute offers accommodation at affordable rates, ensuring students from all backgrounds can access safe and comfortable housing.</p><p>Benefits include:</p><ul><li>Reasonable pricing</li><li>Flexible payment options</li><li>Value for money</li></ul><p class="hst-highlight">We believe quality accommodation should be accessible to all learners.</p></div></div>
  </div></div></section>
  <section class="hst-ideal"><div class="hst-wrap"><div class="hst-ideal-grid"><div><h2>Who Our Hostels Are Ideal For</h2><ul class="hst-ideal-list"><li>Students from outside Nairobi.</li><li>Learners who prefer a structured, safe environment.</li><li>Students who want to minimize transport costs.</li><li>Young learners who need close supervision.</li><li>Anyone seeking a peaceful, study-friendly space.</li></ul><p style="margin-top:20px;font-size:1.05rem;color:#475569;line-height:1.7">Whether you are a first-time student or continuing your studies, GoCare hostels provide the perfect environment for academic success.</p></div><div style="display:flex;justify-content:center;align-items:center"><img loading="lazy" decoding="async" src="images/new-images/IMG_2073.jpg" alt="GoCare Student Hostel Room" style="max-width:100%;border-radius:16px;box-shadow:0 20px 40px rgba(0,0,0,0.1)"></div></div></div></section>
  <section class="hst-cta"><h2>A Home That Supports Your Success</h2><p>At GoCare Training Institute, accommodation is more than a place to sleep &mdash; it is a support system that helps learners stay focused, motivated, and safe.</p><p class="hst-cta-tagline">Your comfort matters. Your safety matters. Your success matters.</p><a href="apply" class="hst-cta-btn">Book a Hostel <i data-lucide="arrow-right" style="width:18px;height:18px"></i></a></section>
</div>
