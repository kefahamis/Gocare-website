...
<head>
  ...
  <title>Certificate in Homecare Management &ndash; Level 3 &ndash; GoCare Training Institute</title>
...
<nav class="nav" id="mainNav">
  ...
  <header class="course-hero">
    <div class="hero-visual">
      <img loading="lazy" decoding="async" src="../images/Homecare-management.jpg" alt="Caregiving Training">
    </div>
    <div class="wrap">
      <div class="course-hero-content">
        <div class="hero-text" style="padding-left: 32px;">
          ...
          <nav class="ph-breadcrumb" aria-label="Breadcrumb">
            <a href="../index">Home</a><i data-lucide="chevron-right"></i><a href="../courses">Courses</a><i data-lucide="chevron-right"></i><span>Certificate in Homecare Management &ndash; Level 3</span>
          </nav>
          <h1>Certificate in Homecare Management &ndash; Level 3</h1>
          ...
          <section class="requirements-box">
            ...
            <div style="background: #fcfcfc; padding: 24px; border-radius: 16px; margin-top: 16px; border: 1px solid #f3f4f6; display: flex; align-items: flex-start; gap: 16px;">
               ...
               <div>
                  ...
                  <p style="font-size: 0.95rem; color: #4b5563; line-height: 1.6;">KCPE or KCSE Certificate (Any Grade)</p>
               </div>
            </div>
            ...
            <div style="background: #fcfcfc; padding: 24px; border-radius: 16px; margin-top: 16px; border: 1px solid #f3f4f6; display: flex; align-items: flex-start; gap: 16px;">
               ...
               <div>
                  ...
                  <p style="font-size: 0.95rem; color: #4b5563; line-height: 1.6;">One (1) Term: Three (3) Months Tuition Duration and Two (2) Months Industrial Attachment</p>
               </div>
            </div>
          </section>
        </div>
