        ...
        <div class="gc-dash-grid gc-dash-grid-top">
            <div class="gc-card gc-hero">
                <div class="gc-hero-inner">
                    ...
                    <h2 class="gc-hero-title">Hello, {{ $initials }}.</h2>
                    <p class="gc-hero-text">Welcome to the Admin clan! We appreciate your interest in our dashboard.</p>
                    <a href="#" class="gc-hero-cta">
                        Go Premium
