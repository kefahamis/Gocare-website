      ...
      <div class="course-hero-content">
        <div class="hero-text" style="padding-left: 32px;">
          ...
          <nav class="ph-breadcrumb" aria-label="Breadcrumb">
            <a href="../index">Home</a><i data-lucide="chevron-right"></i><a href="../schools/international-certifications">International Certifications</a><i data-lucide="chevron-right"></i><a href="aha-emergency-care-programs">AHA Programs</a><i data-lucide="chevron-right"></i><span>Advanced Cardiac Life Support (ACLS) - American Heart Association</span>
          </nav>
