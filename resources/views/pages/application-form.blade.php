...
<head>
  ...
  <title>Application Form - Step 1: Personal Details | GoCare Training Institute</title>
...
<body>
  ...
  <style>
    ...
    .app-hero {
      background: linear-gradient(135deg, rgba(74,26,109,0.95), rgba(100,42,126,0.85)), url('images/courses-application.jpg');
      background-size: cover; background-position: center; padding: 50px 0 40px; margin-bottom: 50px;
    }
    ...
    .form-group input, .form-group select, .form-group textarea {
      width: 100%; padding: 12px 16px; border: 2px solid #e2e8f0; border-radius: 10px; font-size: 1rem;
      font-family: inherit; outline: none; transition: 0.3s; background: #fff;
    }
    ...
    .btn-next { background: linear-gradient(135deg, var(--o), #d05d15); color: #fff; border: none; padding: 14px 40px; border-radius: 10px; font-weight: 700; font-size: 1rem; cursor: pointer; transition: 0.3s; text-transform: uppercase; letter-spacing: 1px; }
    .btn-next:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(236,116,36,0.4); }
    .btn-cancel { background: transparent; color: var(--dark); border: 2px solid var(--dark); padding: 14px 30px; border-radius: 10px; font-weight: 700; font-size: 1rem; cursor: pointer; transition: 0.3s; text-decoration: none; display: inline-block; }
    .btn-cancel:hover { background: var(--dark); color: #fff; }
    ...
    .sidebar-tips h3 i { font-size: 1.3rem; }
  ...
  <main class="app-page">
    <div class="app-hero">
      <div class="app-hero-inner">
        ...
        <p>Step 1 of 6 &mdash; Personal Details</p>
      </div>
    </div>
    ...
    <div class="app-wrap">
      ...
      <div class="stepper">
        <div class="step-item">
          <div class="step-col">
            ...
            <div class="step-label active-label">Personal Details</div>
          </div>
        </div>
        ...
        <div class="step-item">
          <div class="step-col">
            ...
            <div class="step-label pending-label">Education</div>
          </div>
        </div>
        ...
        <div class="step-item">
          <div class="step-col">
            ...
            <div class="step-label pending-label">Course Selection</div>
          </div>
        </div>
        <div class="step-line pending"></div>
        <div class="step-item">
          <div class="step-col">
            ...
            <div class="step-label pending-label">Documents</div>
          </div>
        </div>
        <div class="step-line pending"></div>
        <div class="step-item">
          <div class="step-col">
            ...
            <div class="step-label pending-label">Payment</div>
          </div>
        </div>
        <div class="step-line pending"></div>
        <div class="step-item">
          <div class="step-col">
            ...
            <div class="step-label pending-label">Review &amp; Submit</div>
          </div>
        </div>
      </div>
      ...
      <div class="app-grid">
        ...
        <div class="app-form-card">
          ...
          <form id="step1Form">
            <div class="form-group">
              ...
              <input type="text" placeholder="e.g. John Kamau Mwangi" required>
            </div>
            <div class="form-row">
              <div class="form-group">
                <label>Gender *</label>
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                ...
                <input type="text" placeholder="e.g. 12345678" required>
              </div>
            </div>
            <div class="form-row">
              <div class="form-group">
                ...
                <div class="phone-prefix">
                  <span>+254</span>
                  <input type="tel" placeholder="712345678" required>
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                ...
                <input type="text" placeholder="Estate, Street, House No.">
              </div>
            </div>
            <div class="form-actions">
              <a href="apply" class="btn-cancel">Cancel</a>
              <button type="button" class="btn-next" onclick="window.location.href='application-form-step2'">Save &amp; Continue <i data-lucide="arrow-right" style="width:18px;height:18px;display:inline;vertical-align:middle"></i></button>
            </div>
          </form>
        </div>
        ...
        <div style="display:flex;flex-direction:column;gap:24px;">
          <div class="sidebar-tips">
            ...
            <ul>
              <li><i data-lucide="check-circle-2"></i> Ensure your name matches your national ID exactly.</li>
              <li><i data-lucide="check-circle-2"></i> Provide a valid email &mdash; admission updates go there.</li>
              <li><i data-lucide="check-circle-2"></i> You can save your progress and return later.</li>
            </ul>
          </div>
          ...
          <div class="sidebar-card">
            ...
            <div class="sidebar-body">
              ...
              <ul>
                ...
                <li><i data-lucide="message-circle"></i> WhatsApp Support Available</li>
              </ul>
              <a href="contact" class="btn-next" style="display:block;text-align:center;margin-top:16px;text-decoration:none;font-size:0.9rem;">Contact Support</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="app-footer-nav">
        <a href="apply" class="btn-cancel"><i data-lucide="arrow-left" style="width:18px;height:18px;display:inline;vertical-align:middle"></i> Back to Apply</a>
      </div>
    </div>
  </main>
