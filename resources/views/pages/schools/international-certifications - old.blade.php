    ...
    <div class="ph-inner">
      <div class="ph-content">
        ...
        <nav class="ph-breadcrumb" aria-label="Breadcrumb">
          <a href="../">Home</a><i data-lucide="chevron-right"></i><a href="../courses">Schools & Programs</a><i data-lucide="chevron-right"></i><span>International</span>
        </nav>
  ...
  <section class="cc-section" id="aha-programs" style="background: linear-gradient(180deg, #fff5f5 0%, #fff8f3 55%, #fcf9f8 100%);">
    <div class="wrap">
      ...
      <div class="cc-grid">
        ...
        <a href="../courses/pediatric-advanced-life-support-pals" class="cc-card">
        ...
        <a href="../courses/heartsaver-first-aid" class="cc-card">
  ...
  <section class="cc-section">
    <div class="wrap">
      <div class="cc-header">
        ...
        <p>Earn globally recognised qualifications that open doors to international healthcare and hospitality careers.</p>
      </div>
      ...
      <div class="cc-grid">
        ...
        <a href="../courses/amca-usa-certification" class="cc-card" data-type="certificate">
        ...
        <a href="../courses/sdc-canada-certification" class="cc-card" data-type="certificate">
          <div class="cc-card-top certificate"><img loading="lazy" decoding="async" src="../images/new-images/IMG_5498.JPG.jpeg" alt="SDC Canada" style="background:#f8f6fc;"></div>
          <div class="cc-card-body">
            <div class="cc-badge-row">
            ...
            <div class="cc-title">Skill Development Council (SDC) &ndash; Canada Certification</div>
        ...
        <a href="../courses/second-course-sponsorship" class="cc-card" data-type="short-course">
