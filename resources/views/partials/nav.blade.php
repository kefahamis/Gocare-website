...
<nav class="nav" id="mainNav">
  <div class="nav-inner">
    ...
    <div class="nav-right">
      <a href="/apply" class="nav-apply-btn">{{ $frontend['apply_label'] ?? 'Start Your Journey' }} <i data-lucide="arrow-right"></i></a>
  ...
  <div class="mob-menu" id="mobMenu">
    ...
    @endforeach
    <a href="/apply" class="btn btn-primary mob-cta">{{ $frontend['apply_label'] ?? 'Start Your Journey' }} <i data-lucide="arrow-right"></i></a>
  </div>
</nav>
...
<div class="subbar">
  <div class="wrap subbar-inner">
    <span class="subbar-tagline">{{ $frontend['tagline'] ?? 'Train With The Experts... Become an Expert!' }}</span>
