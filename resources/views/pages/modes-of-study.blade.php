...
<head>
  ...
  <title>Modes of Study | GoCare Training Institute</title>
...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .mos-page { padding-top: 0; }
  .mos-hero { background: linear-gradient(135deg, var(--dark) 0%, #2d0f3c 60%, #1a0924 100%); padding: 100px 0 80px; text-align: center; position: relative; overflow: hidden; }
  .mos-hero::before { content: ''; position: absolute; inset: 0; background: radial-gradient(circle at 20% 50%, rgba(236,116,37,0.15) 0%, transparent 50%), radial-gradient(circle at 80% 30%, rgba(100,42,126,0.2) 0%, transparent 40%); pointer-events: none; }
  .mos-hero-inner { position: relative; z-index: 2; max-width: 850px; margin: 0 auto; padding: 0 20px; }
  .mos-hero-badge { display: inline-flex; align-items: center; gap: 8px; background: rgba(236,116,37,0.15); color: var(--o); padding: 8px 20px; border-radius: 50px; font-size: .85rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 24px; border: 1px solid rgba(236,116,37,0.25); }
  .mos-hero h1 { font-size: 3.2rem; font-weight: 800; color: #fff; line-height: 1.1; margin-bottom: 16px; }
  .mos-hero h1 span { color: var(--o); }
  .mos-hero-sub { display: flex; justify-content: center; flex-wrap: wrap; gap: 12px; margin-bottom: 24px; }
  .mos-hero-sub span { background: rgba(255,255,255,0.1); color: rgba(255,255,255,0.85); padding: 6px 16px; border-radius: 50px; font-size: .8rem; font-weight: 600; border: 1px solid rgba(255,255,255,0.15); }
  .mos-hero p { font-size: 1.1rem; color: rgba(255,255,255,0.75); max-width: 720px; margin: 0 auto; line-height: 1.7; }
  .mos-hero p strong { color: #fff; }
  .mos-section { padding: 80px 0; }
  .mos-wrap { max-width: 1200px; margin: 0 auto; padding: 0 20px; }
  .mos-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 32px; }
  .mos-card { background: #fff; border-radius: 20px; overflow: hidden; border: 1px solid #e2e8f0; transition: transform .25s, box-shadow .25s; position: relative; }
  .mos-card:hover { transform: translateY(-6px); box-shadow: 0 20px 40px rgba(74,26,109,0.12); }
  .mos-card-accent { height: 6px; background: linear-gradient(90deg, var(--o), var(--p)); }
  .mos-card-head { padding: 28px 28px 0; display: flex; align-items: flex-start; gap: 16px; }
  .mos-card-icon { flex-shrink: 0; width: 56px; height: 56px; border-radius: 14px; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, rgba(236,116,37,0.12), rgba(100,42,126,0.08)); color: var(--o); }
  .mos-card-head h3 { font-size: 1.25rem; font-weight: 700; color: var(--dark); line-height: 1.3; margin-bottom: 4px; }
  .mos-card-head .mos-card-tag { font-size: .82rem; color: #94a3b8; font-weight: 500; }
  .mos-card-body { padding: 16px 28px 28px; }
  .mos-card-body > p { font-size: .92rem; color: #64748b; line-height: 1.6; margin-bottom: 16px; }
  .mos-card-body h4 { font-size: .85rem; font-weight: 700; color: var(--dark); text-transform: uppercase; letter-spacing: .5px; margin-bottom: 8px; margin-top: 16px; }
  .mos-card-body h4:first-of-type { margin-top: 0; }
  .mos-card-body ul { list-style: none; padding: 0; margin-bottom: 8px; }
  .mos-card-body ul li { position: relative; padding-left: 24px; margin-bottom: 6px; font-size: .88rem; color: #475569; line-height: 1.5; }
  .mos-card-body ul li::before { content: ''; position: absolute; left: 0; top: 8px; width: 6px; height: 6px; border-radius: 50%; background: var(--o); }
  .mos-card-online { grid-column: 1 / -1; }
  .mos-card-online .mos-card-inner { display: grid; grid-template-columns: 1fr 1fr; gap: 0; }
  .mos-card-online .mos-card-body { padding: 28px; }
  .mos-why { background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); padding: 80px 0; }
  .mos-why h2 { font-size: 2.2rem; font-weight: 800; color: var(--dark); margin-bottom: 16px; }
  .mos-why-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 40px; align-items: start; }
  .mos-why-list { list-style: none; padding: 0; }
  .mos-why-list li { position: relative; padding-left: 32px; margin-bottom: 14px; font-size: 1rem; color: #475569; line-height: 1.5; }
  .mos-why-list li::before { content: '✓'; position: absolute; left: 0; top: 0; color: var(--o); font-weight: 800; font-size: 1.1rem; }
  .mos-equal { background: #fff; border-radius: 16px; padding: 28px; border: 1px solid #e2e8f0; }
  .mos-equal h4 { font-size: .9rem; font-weight: 700; color: var(--dark); margin-bottom: 12px; }
  .mos-equal ul { list-style: none; padding: 0; }
  .mos-equal ul li { position: relative; padding-left: 28px; margin-bottom: 10px; font-size: .92rem; color: #475569; }
  .mos-equal ul li::before { content: ''; position: absolute; left: 0; top: 7px; width: 8px; height: 8px; border-radius: 50%; background: linear-gradient(135deg, var(--o), var(--p)); }
  .mos-cta { text-align: center; padding: 80px 20px; background: linear-gradient(135deg, var(--o) 0%, #d05d15 50%, #b84d0f 100%); position: relative; overflow: hidden; }
  .mos-cta::before { content: ''; position: absolute; inset: 0; background: radial-gradient(circle at 30% 20%, rgba(255,255,255,0.12) 0%, transparent 50%), radial-gradient(circle at 80% 80%, rgba(255,255,255,0.08) 0%, transparent 40%); pointer-events: none; }
  .mos-cta > * { position: relative; z-index: 2; }
  .mos-cta h2 { font-size: 2.4rem; font-weight: 800; color: #fff; margin-bottom: 16px; }
  .mos-cta p { font-size: 1.05rem; color: rgba(255,255,255,0.9); max-width: 650px; margin: 0 auto 12px; line-height: 1.7; }
  .mos-cta-btn { display: inline-flex; align-items: center; gap: 10px; background: #fff; color: var(--o); padding: 16px 36px; border-radius: 50px; font-weight: 700; font-size: 1rem; box-shadow: 0 10px 30px rgba(0,0,0,0.15); transition: transform .2s, box-shadow .2s; margin-top: 12px; }
  .mos-cta-btn:hover { transform: translateY(-3px); box-shadow: 0 15px 40px rgba(0,0,0,0.25); }
  @media (max-width: 1024px) { .mos-grid { grid-template-columns: 1fr; } .mos-card-online { grid-column: auto; } .mos-card-online .mos-card-inner { grid-template-columns: 1fr; } .mos-why-grid { grid-template-columns: 1fr; } .mos-hero h1 { font-size: 2.6rem; } }
  @media (max-width: 768px) { .mos-hero { padding: 80px 0 60px; } .mos-hero h1 { font-size: 2rem; } .mos-section { padding: 60px 0; } .mos-card-head { padding: 24px 20px 0; } .mos-card-body { padding: 12px 20px 24px; } .mos-card-online .mos-card-body { padding: 20px; } .mos-cta h2 { font-size: 1.8rem; } }
  @media (max-width: 480px) { .mos-hero h1 { font-size: 1.7rem; } .mos-cta-btn { width: 100%; justify-content: center; } .mos-hero-sub span { font-size: .72rem; padding: 5px 12px; } }

  /* MOS Photo Strips & Splits */
  .mos-photo-strip { display:grid; grid-template-columns:1fr 1fr 1fr; height:260px; gap:6px; }
  .mos-photo-strip img { width:100%; height:100%; object-fit:cover; display:block; }
  .mos-split { display:grid; grid-template-columns:1fr 1fr; border-radius:16px; overflow:hidden; border:1px solid #e2e8f0; margin:40px 0; }
  .mos-split-img { overflow:hidden; min-height:280px; }
  .mos-split-img img { width:100%; height:100%; object-fit:cover; }
  .mos-split-body { padding:36px 32px; display:flex; flex-direction:column; justify-content:center; background:#fcf9f8; }
  .mos-split-body h3 { font-size:1.3rem; font-weight:800; color:#4a1a6d; margin-bottom:12px; }
  .mos-split-body p { font-size:.95rem; color:#475569; line-height:1.7; }
  @media(max-width:768px){ .mos-photo-strip{grid-template-columns:1fr 1fr;height:180px;} .mos-photo-strip img:last-child{display:none;} .mos-split{grid-template-columns:1fr;} .mos-split-img{min-height:220px;} }

  /* Card top images */
  .mos-card-img { height: 200px; overflow: hidden; }
  .mos-card-img img { width:100%; height:100%; object-fit:cover; display:block; transition: transform .6s ease; }
  .mos-card:hover .mos-card-img img { transform: scale(1.05); }

  /* Online card &ndash; image left panel */
  .mos-online-img { position: relative; overflow: hidden; }
  .mos-online-img img { width:100%; height:100%; min-height:300px; object-fit:cover; display:block; }
  .mos-online-img::after { content:''; position:absolute; inset:0; background:linear-gradient(to top, rgba(74,26,109,.90) 0%, rgba(74,26,109,.45) 55%, transparent 100%); }
  .mos-online-img-text { position:absolute; bottom:0; left:0; right:0; padding:24px 28px; z-index:1; }
  .mos-online-img-text .mos-card-icon { background:rgba(255,255,255,.15); backdrop-filter:blur(8px); -webkit-backdrop-filter:blur(8px); color:#fff; border:1px solid rgba(255,255,255,.22); margin-bottom:12px; }
  .mos-online-img-text h3 { color:#fff; font-size:1.2rem; font-weight:700; margin-bottom:4px; }
  .mos-online-img-text .mos-card-tag { color:rgba(255,255,255,.72); font-size:.82rem; font-weight:500; }

  /* Why section image */
  .mos-why-img { border-radius:14px; overflow:hidden; height:220px; margin-bottom:20px; }
  .mos-why-img img { width:100%; height:100%; object-fit:cover; display:block; }

  @media(max-width:1024px){ .mos-online-img img { min-height:220px; } }
</style>
<div class="mos-page">
    <!-- PAGE HERO -->
  <section class="ph">
    <div class="ph-bg">
      <img loading="eager" decoding="async" src="images/new-images/6.jpg" alt="Flexible Learning">
    </div>
    <div class="ph-overlay"></div>
    <div class="ph-inner">
      <div class="ph-content">
        <span class="ph-eyebrow"><i data-lucide="book-open"></i> Flexible Learning</span>
        <nav class="ph-breadcrumb" aria-label="Breadcrumb">
          <a href="/">Home</a><i data-lucide="chevron-right"></i><span>Modes of Study</span>
        </nav>
        <h1>Modes of <em>Study</em></h1>
        <p>Study your way &ndash; full-time, part-time, or blended learning. GoCare offers flexible pathways designed to fit around your life and career commitments.</p>
        <div class="ph-btns">
          <a href="apply" class="ph-btn-primary">Apply Now <i data-lucide="arrow-right"></i></a>
          <a href="courses" class="ph-btn-ghost">View Courses <i data-lucide="arrow-right"></i></a>
        </div>
  </div>
  ...
  <section class="mos-section"><div class="mos-wrap"><div class="mos-section-header" style="text-align:center;margin-bottom:56px"><h2 style="font-size:2.2rem;font-weight:800;color:var(--dark);margin-bottom:12px">Choose Your Preferred Study Mode</h2><p style="font-size:1.05rem;color:#64748b;max-width:550px;margin:0 auto">We offer four flexible modes of study to suit your lifestyle, schedule, and learning preferences.</p></div><div class="mos-grid">
    <div class="mos-card"><div class="mos-card-img"><img loading="lazy" decoding="async" src="images/new-images/PXL_20260218_064240333.MP~2.jpg" alt="Daytime classroom learning"></div><div class="mos-card-accent"></div><div class="mos-card-head"><div class="mos-card-icon"><i data-lucide="sun" style="width:28px;height:28px"></i></div><div><h3>Daytime Classes</h3><div class="mos-card-tag">Full-time &ndash; In-person</div></div></div><div class="mos-card-body"><p>Ideal for full-time students who prefer structured, in-person learning. Daytime classes offer a traditional, immersive learning experience.</p><h4>What You Get</h4><ul><li>Face-to-face interaction with trainers</li><li>Hands-on practical sessions in labs</li><li>Group activities and peer learning</li><li>Access to campus facilities throughout the day</li></ul><h4>Best For</h4><ul><li>Recent KCSE graduates</li><li>Students who prefer in-person learning</li><li>Learners who want maximum practical exposure</li></ul></div></div>
    <div class="mos-card"><div class="mos-card-img"><img loading="lazy" decoding="async" src="images/new-images/IMG_3623.JPG" alt="Evening study session"></div><div class="mos-card-accent"></div><div class="mos-card-head"><div class="mos-card-icon"><i data-lucide="moon" style="width:28px;height:28px"></i></div><div><h3>Evening Classes</h3><div class="mos-card-tag">Part-time &ndash; After hours</div></div></div><div class="mos-card-body"><p>Perfect for working professionals, parents, and busy learners. Evening classes provide flexibility without compromising quality.</p><h4>Balance Your Commitments</h4><ul><li>Employment</li><li>Family responsibilities</li><li>Personal commitments</li></ul><h4>Benefits</h4><ul><li>Convenient schedules</li><li>Smaller class sizes</li><li>Same curriculum and certification as daytime students</li></ul><h4>Best For</h4><ul><li>Working adults</li><li>Career changers</li><li>Parents with daytime responsibilities</li></ul></div></div>
    <div class="mos-card"><div class="mos-card-img"><img loading="lazy" decoding="async" src="images/new-images/IMG_2800.JPG" alt="Weekend campus learning"></div><div class="mos-card-accent"></div><div class="mos-card-head"><div class="mos-card-icon"><i data-lucide="calendar" style="width:28px;height:28px"></i></div><div><h3>Saturday Classes</h3><div class="mos-card-tag">Weekend &ndash; Once a week</div></div></div><div class="mos-card-body"><p>Designed for learners who prefer weekend study. Saturday classes offer a focused, once-a-week learning experience for students who cannot attend weekday sessions.</p><h4>Benefits</h4><ul><li>One full day of learning</li><li>Practical sessions included</li><li>Ideal for long-distance learners</li><li>Perfect for those with weekday commitments</li></ul><h4>Best For</h4><ul><li>Employed learners</li><li>Business owners</li><li>Students living outside Nairobi</li></ul></div></div>
    <div class="mos-card mos-card-online"><div class="mos-card-accent"></div><div class="mos-card-inner"><div class="mos-online-img"><img loading="lazy" decoding="async" src="images/new-images/IMG_4408.jpg" alt="Flexible GoCare learning"><div class="mos-online-img-text"><div class="mos-card-icon"><i data-lucide="monitor" style="width:28px;height:28px"></i></div><h3>Online / Distance Learning</h3><div class="mos-card-tag">Remote &ndash; Flexible &ndash; Digital</div></div></div><div class="mos-card-body"><p>Modern, flexible, and accessible from anywhere in Kenya. GoCare Training Institute offers online and blended learning options for selected programs, allowing learners to study from home, work, or while traveling.</p><h4>Features</h4><ul><li>Virtual classes</li><li>Digital learning materials</li><li>Online assessments</li><li>Trainer support via digital platforms</li></ul><h4>Benefits</h4><ul><li>Study at your own pace</li><li>Save time and transport costs</li><li>Ideal for learners outside Nairobi</li></ul><h4>Best For</h4><ul><li>Remote learners</li><li>Busy professionals</li><li>Students seeking flexible schedules</li></ul></div></div></div>
  </div></div></section>
  <div class="mos-wrap" style="padding-bottom:0">
    <div class="mos-photo-strip" style="border-radius:14px;overflow:hidden;">
      <img loading="lazy" decoding="async" src="images/new-images/IMG_0975 (2).JPG" alt="GoCare students on campus">
      <img loading="lazy" decoding="async" src="images/new-images/IMG_3300-cna.JPG" alt="Clinical skills training">
      <img loading="lazy" decoding="async" src="images/new-images/IMG_7559.JPG" alt="Students at GoCare facility">
    </div>
  </div>
  <section class="mos-why"><div class="mos-wrap"><div class="mos-why-grid"><div><h2>Why Our Flexible Study Modes Matter</h2><p style="font-size:1rem;color:#64748b;margin-bottom:24px;line-height:1.6">GoCare's study modes are designed to support every type of learner and ensure no one is left behind.</p><ul class="mos-why-list"><li>Support different lifestyles</li><li>Increase accessibility</li><li>Promote work-study balance</li><li>Ensure no learner is left behind</li><li>Provide equal quality across all modes</li></ul></div><div><div class="mos-why-img"><img loading="lazy" decoding="async" src="images/new-images/IMG_1292.JPG" alt="Hands-on patient care training"></div><div class="mos-equal"><h4>No matter which mode you choose, you receive:</h4><ul><li>The same accredited curriculum</li><li>The same practical training</li><li>The same certifications</li><li>The same career opportunities</li></ul></div></div></div></div></section>
  <section class="mos-cta"><h2>Your Education, Your Schedule</h2><p>At GoCare Training Institute, flexibility is not an option &ndash; it's a commitment. We ensure every learner can access quality, accredited, practical training in a way that fits their life.</p><a href="apply" class="mos-cta-btn">Apply Now <i data-lucide="arrow-right" style="width:18px;height:18px"></i></a></section>
</div>
