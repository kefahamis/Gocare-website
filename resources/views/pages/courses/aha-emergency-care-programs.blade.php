      ...
      <div class="course-hero-content">
        <div class="hero-text" style="padding-left: 32px;">
          ...
          <nav class="ph-breadcrumb" aria-label="Breadcrumb">
            <a href="../">Home</a><i data-lucide="chevron-right"></i><a href="../schools/international-certifications">International Certifications</a><i data-lucide="chevron-right"></i><span>AHA Emergency Care Programs</span>
          </nav>
