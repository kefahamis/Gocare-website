...
<head>
  ...
  <link rel="apple-touch-icon" href="images/gocare-institute-logo.png"><meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Difference Between Caregiver, HCA, and CNA | GoCare Institute</title>
  ...
  <style>.bp-wrap{max-width:820px;margin:0 auto;padding:60px 32px 100px}.bp-eyebrow{display:inline-flex;align-items:center;gap:7px;background:var(--ol);color:var(--o);padding:5px 16px;border-radius:50px;font-size:.78rem;font-weight:800;text-transform:uppercase;letter-spacing:.08em;margin-bottom:20px}.bp-title{font-family:Outfit,sans-serif;font-size:2.6rem;font-weight:900;color:var(--dark);line-height:1.2;margin-bottom:12px}.bp-subtitle{font-size:1.1rem;color:#6B7280;margin-bottom:24px}.bp-meta{display:flex;align-items:center;gap:16px;font-size:.82rem;color:#94a3b8;margin-bottom:36px;padding-bottom:28px;border-bottom:1px solid var(--border);flex-wrap:wrap}.bp-meta span{display:flex;align-items:center;gap:5px}.bp-hero{width:100%;height:420px;object-fit:cover;border-radius:16px;margin-bottom:44px;display:block}.bp-body{font-size:1.02rem;color:#374151;line-height:1.82}.bp-body h2{font-family:Outfit,sans-serif;font-size:1.55rem;font-weight:800;color:var(--dark);margin:44px 0 14px}.bp-body h3{font-size:1.15rem;font-weight:700;color:var(--dark);margin:28px 0 10px}.bp-body p{margin-bottom:18px}.bp-body ul{margin:0 0 20px;padding-left:0;list-style:none}.bp-body ul li{padding:5px 0 5px 28px;position:relative}.bp-body ul li::before{content:"";position:absolute;left:0;top:13px;width:8px;height:8px;border-radius:50%;background:var(--o)}.bp-body ol{counter-reset:ol;padding-left:0;list-style:none;margin:0 0 20px}.bp-body ol li{counter-increment:ol;padding:6px 0 6px 32px;position:relative}.bp-body ol li::before{content:counter(ol) ".";position:absolute;left:0;top:6px;font-weight:700;color:var(--o)}.bp-callout{background:var(--ol);border-left:4px solid var(--o);border-radius:0 10px 10px 0;padding:20px 24px;margin:28px 0}.bp-callout p{margin:0;font-weight:600;color:var(--dark)}.bp-cta{background:linear-gradient(135deg,var(--dark),#2d0f3c);border-radius:16px;padding:44px 40px;text-align:center;margin-top:56px}.bp-cta h3{font-family:Outfit,sans-serif;font-size:1.6rem;color:#fff;margin-bottom:10px}.bp-cta p{color:rgba(255,255,255,.75);margin-bottom:24px}.bp-cta a{display:inline-flex;align-items:center;gap:8px;background:var(--o);color:#fff;font-weight:700;padding:13px 30px;border-radius:50px;transition:.2s}.bp-cta a:hover{background:#d4611a;transform:translateY(-2px)}.bp-back{display:inline-flex;align-items:center;gap:6px;color:var(--o);font-weight:700;font-size:.88rem;margin-bottom:32px}.course-card{background:#F5F0E8;border-radius:14px;padding:22px 26px;margin-bottom:18px;border-left:4px solid var(--o)}.course-card h3{margin:0 0 6px;font-size:1.05rem;font-weight:800;color:var(--dark)}.course-card .entry{font-size:.82rem;font-weight:700;color:var(--dark);margin-bottom:10px}.compare-table{width:100%;border-collapse:collapse;margin:24px 0;border-radius:12px;overflow:hidden}.compare-table th{background:var(--dark);color:#fff;padding:12px 16px;text-align:left;font-size:.88rem}.compare-table td{padding:11px 16px;border-bottom:1px solid var(--border);font-size:.9rem}.compare-table tr:nth-child(even) td{background:#F5F0E8}.compare-table-scroll{overflow-x:auto;-webkit-overflow-scrolling:touch;margin:24px 0;border-radius:12px}.compare-table-scroll .compare-table{margin:0;min-width:520px}@media(max-width:640px){.bp-wrap{padding:32px 20px 80px}.bp-title{font-size:1.8rem}.bp-hero{height:240px}.bp-cta{padding:32px 24px}}</style>
...
<body>
  ...
  <div class="subbar"><div class="wrap subbar-inner"><span class="subbar-tagline">Train With The Experts... Become an Expert!</span><div class="subbar-portals"><a href="#" class="subbar-btn subbar-btn--student">Student Portal</a><a href="#" class="subbar-btn subbar-btn--staff">Staff Portal</a></div></div></div>
  <main><div class="bp-wrap">
    <a href="blog" class="bp-back"><i data-lucide="arrow-left" style="width:16px;height:16px"></i> Back to Blog</a>
    <span class="bp-eyebrow"><i data-lucide="stethoscope" style="width:14px;height:14px"></i> Healthcare</span>
    <h1 class="bp-title">Difference Between Caregiver, HCA, and CNA</h1>
    <p class="bp-subtitle">Clear definitions, roles, qualifications, salaries, and career pathways &mdash; so you can choose the right course for your goals.</p>
    <div class="bp-meta">
      <span><i data-lucide="clock" style="width:14px;height:14px"></i> 6 min read</span>
      <span><i data-lucide="calendar" style="width:14px;height:14px"></i> 04 Jun 2026</span>
      <span><i data-lucide="tag" style="width:14px;height:14px"></i> Healthcare</span>
    </div>
    <img loading="lazy" decoding="async" class="bp-hero" src="images/new-images/DSC01144.jpg" alt="Difference between caregiver HCA and CNA">
    <div class="bp-body"><p>Many students confuse the terms Caregiver, Health Care Assistant (HCA), and Certified Nursing Assistant (CNA) &mdash; yet these roles are very different in training level, responsibilities, salary, and international opportunities. This guide gives you a clear, simple, and accurate breakdown.</p>
<h2>1. Who Is a Caregiver?</h2>
<p>A Caregiver provides basic support to clients who need help with daily living activities, either at home or in a care facility.</p>
<ul>
  <li><strong>Main duties:</strong> Bathing, grooming, feeding, mobility assistance, repositioning, companionship, light housekeeping</li>
  <li><strong>Where they work:</strong> Private homes, homecare agencies, elderly care centres, disability support homes</li>
  <li><strong>Entry:</strong> KCSE (Any Grade) or KCPE for Level 3</li>
  <li><strong>Courses:</strong> Certificate in Caregiving &ndash; Level 4, Caregiver Course &ndash; Level II (NITA), Home-Based Care Support &ndash; Level 3</li>
  <li><strong>Salary in Kenya:</strong> KES 20,000 &ndash; 45,000/month</li>
  <li><strong>Best for:</strong> Beginners entering the healthcare field</li>
</ul>
<h2>2. Who Is a Health Care Assistant (HCA)?</h2>
<p>An HCA works in hospitals, clinics, and medical facilities under the supervision of nurses and clinicians, performing more clinical tasks than caregivers.</p>
<ul>
  <li><strong>Main duties:</strong> Taking vital signs, Assisting nurses, Infection control, Patient hygiene, Feeding and mobility, Bedside care, Basic documentation</li>
  <li><strong>Where they work:</strong> Hospitals, Clinics, Nursing homes, Rehabilitation centres</li>
  <li><strong>Entry:</strong> KCPE or KCSE (Any Grade)</li>
  <li><strong>Courses:</strong> Certificate in Health Care Assistant (HCA), Caregiving &ndash; Level 4</li>
  <li><strong>Salary in Kenya:</strong> KES 25,000 &ndash; 50,000/month</li>
  <li><strong>Best for:</strong> Learners who want hospital-based experience</li>
</ul>
<h2>3. Who Is a Certified Nursing Assistant (CNA)?</h2>
<p>A CNA is the most advanced of the three roles &mdash; a licensed, clinically trained healthcare professional who works directly within medical teams in hospitals and care facilities.</p>
<ul>
  <li><strong>Main duties:</strong> All HCA duties plus advanced patient monitoring, clinical procedures, emergency response, documentation and reporting to nurses</li>
  <li><strong>Where they work:</strong> Hospitals, Clinics, Long-term care facilities, International healthcare settings</li>
  <li><strong>Entry:</strong> KCSE D (Plain) and above</li>
  <li><strong>Courses:</strong> Healthcare Support Services &ndash; Level 5 (CNA)</li>
  <li><strong>Salary in Kenya:</strong> KES 30,000 &ndash; 60,000/month. International: KES 150,000 &ndash; 450,000/month</li>
  <li><strong>Best for:</strong> Learners targeting licensed, hospital-level, and international positions</li>
</ul>
<h2>Quick Comparison</h2>
<div class="compare-table-scroll"><table class="compare-table">
  <thead><tr><th>Feature</th><th>Caregiver</th><th>HCA</th><th>CNA</th></tr></thead>
  <tbody>
    <tr><td>Entry Grade</td><td>Any grade / KCPE</td><td>Any grade / KCPE</td><td>KCSE D (Plain)+</td></tr>
    <tr><td>Duration</td><td>5&ndash;8 months</td><td>5 months</td><td>1&frac12; years</td></tr>
    <tr><td>Clinical Level</td><td>Basic</td><td>Intermediate</td><td>Advanced</td></tr>
    <tr><td>KHPOA Licence</td><td>No</td><td>No</td><td>Yes (Level 5)</td></tr>
    <tr><td>International Scope</td><td>Moderate</td><td>Good</td><td>Excellent</td></tr>
    <tr><td>Kenya Salary</td><td>KES 20k&ndash;45k</td><td>KES 25k&ndash;50k</td><td>KES 30k&ndash;60k</td></tr>
  </tbody>
</table></div>
<div class="bp-callout"><p>All three pathways are available at GoCare Training Institute &mdash; and all include FREE fully sponsored international certification (SDC Canada or AMCA USA) to maximise your global employability.</p></div><h2>Why Train at GoCare Training Institute?</h2><ul><li>Accredited and TVETA-licensed programmes</li><li>Competency-based, TVET CDACC-aligned curriculum</li><li>Guaranteed industrial and hospital attachment</li><li>FREE fully sponsored international certification (SDC Canada / AMCA USA)</li><li>Modern practical skills labs</li><li>Two campuses &mdash; Nairobi CBD and Ruiru</li><li>High graduate employability in Kenya and abroad</li></ul><div class="bp-callout"><p>GoCare equips you with nationally accredited qualifications, international certification, and guaranteed attachment &mdash; giving you the competence and confidence to succeed anywhere.</p></div></div>
    <div class="bp-cta">
      <h3>Choose Your Healthcare Pathway at GoCare</h3>
      <p>From Caregiver Level 3 to CNA Level 5 &mdash; GoCare has the right programme for your grade, timeline, and career goals.</p>
      <a href="apply">Apply Now <i data-lucide="arrow-right" style="width:16px;height:16px"></i></a>
    </div>
  </div></main>
...
<span class="accred-badge"><img loading="eager" decoding="async" src="images/partners/knec.png" alt="KNEC logo"></span>
  ...
  <script>document.addEventListener("DOMContentLoaded",function(){lucide.createIcons();var n=document.getElementById("mainNav");window.addEventListener("scroll",function(){n.classList.toggle("scrolled",window.scrollY>40)});var h=document.getElementById("hamBtn"),m=document.getElementById("mobMenu");if(h&&m){const _ov=document.createElement("div");_ov.className="mob-overlay";document.body.appendChild(_ov);const _ls=document.querySelector(".logo img")?.src||"images/gocare-institute-logo.png";const _dh=document.createElement("div");_dh.className="mob-drawer-head";_dh.innerHTML="<img loading="lazy" decoding="async" src='\+_ls\+' alt='GoCare'><button class='mob-drawer-close' id='mobClose'><svg viewBox='0 0 24 24'><line x1='18' y1='6' x2='6' y2='18'/><line x1='6' y1='6' x2='18' y2='18'/></svg></button>";document.body.appendChild(m);m.prepend(_dh);function _od(){h.classList.add("open");_ov.style.display="block";m.animate([{transform:"translateX(105vw)"},{transform:"translateX(0)"}],{duration:450,easing:"cubic-bezier(.76,0,.24,1)",fill:"forwards"});_ov.animate([{opacity:0},{opacity:1}],{duration:280,fill:"forwards"});document.body.style.overflow="hidden";}function _cd(){h.classList.remove("open");document.body.style.overflow="";m.animate([{transform:"translateX(0)"},{transform:"translateX(105vw)"}],{duration:450,easing:"cubic-bezier(.76,0,.24,1)",fill:"forwards"});_ov.animate([{opacity:1},{opacity:0}],{duration:280,fill:"forwards"}).onfinish=()=>{_ov.style.display="none";};}h.addEventListener("click",()=>h.classList.contains("open")?_cd():_od());m.querySelectorAll("a").forEach(a=>a.addEventListener("click",_cd));_ov.addEventListener("click",_cd);document.getElementById("mobClose").addEventListener("click",_cd);}});</script>
