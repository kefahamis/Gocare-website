...
<head>
  ...
  <title>Certificate in Community Based Services – Level 4 &ndash; GoCare Training Institute</title>
...
<nav class="nav" id="mainNav">
  ...
  <header class="course-hero">
    <div class="hero-visual">
      <img loading="lazy" decoding="async" src="../images/new-images/Community-Based-Services-l4.jpg" alt="Community Based Services Training">
    </div>
    <div class="wrap">
      <div class="course-hero-content">
        <div class="hero-text" style="padding-left: 32px;">
          <span class="course-badge"><i data-lucide="award"></i> TVETA Accredited &ndash; Competency Based &ndash; TVET CDACC Certified</span>
          <nav class="ph-breadcrumb" aria-label="Breadcrumb">
            <a href="../index">Home</a><i data-lucide="chevron-right"></i><a href="../courses">Courses</a><i data-lucide="chevron-right"></i><span>Certificate in Community Based Services &ndash; Level 4</span>
          </nav>
          <h1>Certificate in Community Based Services &ndash; <span style="color:var(--o)">Level 4</span></h1>
          <p class="intro">An entry-level, competency-based program that introduces learners to foundational skills in community health support, household health assistance, hygiene promotion, and basic community-based care.</p>
  ...
  <!-- -- MAIN CONTENT ---------------------------------- -->
  <main class="course-main" style="padding: 24px 0; background: #f8fafc;">
    <div class="wrap">
      <div class="course-grid-layout" style="display: grid; grid-template-columns: 1fr 350px; gap: 40px; align-items: start;">
        <div class="course-body" style="background: #fcfcfc; padding: 24px; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.05);">
          
          <section class="course-description">
            <h2 class="course-sec-title">Course Overview</h2>
            <p>The <strong>Certificate in Community Based Services – Level 4</strong> is an entry-level, competency-based program designed to introduce learners to foundational skills in community health support, household health assistance, hygiene promotion, and basic community-based care.</p>
            <p>This program prepares trainees to work under supervision in community units, health facilities, NGOs, and public health outreach programs. Learners gain practical exposure through skills lab sessions, supervised field practice, and hospital/community attachments.</p>
            <div style="background: rgba(237, 116, 37, 0.05); border-left: 4px solid var(--o); padding: 20px; border-radius: 4px; margin-top: 10px;">
              <p style="margin: 0; font-style: italic; color: var(--dark);">This Level 4 qualification provides a direct progression pathway into Level 5 (Certificate in Community Health Assistant) and Level 6 (Diploma in Community Health Assistant).</p>
            </div>
          </section>

          <section class="course-description" style="margin-top: 14px;">
            ...
            <div style="display: grid; gap: 15px;">
              <div style="display: flex; gap: 15px; align-items: flex-start;">
                ...
                <p style="margin: 0;">Fully TVETA accredited and TVET CDACC certified institution.</p>
              </div>
              <div style="display: flex; gap: 15px; align-items: flex-start;">
                ...
                <p style="margin: 0;">Competency-based curriculum aligned with national community health standards.</p>
              </div>
              <div style="display: flex; gap: 15px; align-items: flex-start;">
                ...
                <p style="margin: 0;">Hands-on training in household health support and community outreach.</p>
              </div>
              <div style="display: flex; gap: 15px; align-items: flex-start;">
                ...
                <p style="margin: 0;">Modern skills lab and simulation-based learning.</p>
              </div>
              <div style="display: flex; gap: 15px; align-items: flex-start;">
                ...
                <p style="margin: 0;">Guaranteed attachment placement in accredited hospitals and community units.</p>
              </div>
              <div style="display: flex; gap: 15px; align-items: flex-start;">
                ...
                <p style="margin: 0;">High employability in entry-level community health support roles.</p>
              </div>
              <div style="display: flex; gap: 15px; align-items: flex-start;">
                ...
                <p style="margin: 0;">Direct progression to Level 5 and Level 6 Community Health Assistant programs.</p>
              </div>
            </div>
          </section>

          <section class="requirements-box" style="margin-top: 14px; background: #fcfcfc; padding: 16px; border-radius: 12px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);">
            ...
            <div class="requirements-grid" style="display: grid; gap: 20px;">
              <div class="req-item" style="display: flex; gap: 15px; align-items: center;">
                ...
                <div>
                  <p style="margin: 0; font-size: 16px; color: var(--dark); font-weight: 600;">KCSE Certificate (Any Grade)</p>
                  <p style="margin: 4px 0 0; font-size: 14px; color: var(--gray);">This makes Level 4 the most accessible entry point into the community health career pathway.</p>
                </div>
              </div>
            </div>
          </section>

          <section class="modules-list" style="margin-top: 10px;">
            <h2 class="course-sec-title">What You Will Learn (Units of Competence)</h2>
            <div style="display: grid; grid-template-columns: 1fr; gap: 10px; background: #f8fafc; padding: 16px; border-radius: 8px;">
              <ul style="list-style: none; padding: 0;">
                ...
                <li style="margin-bottom: 12px; display: flex; gap: 10px; align-items: flex-start;"><i data-lucide="chevron-right" style="color: var(--o); flex-shrink: 0; width: 18px; margin-top: 3px;"></i> Entrepreneurship Skills</li>
                <li style="margin-bottom: 12px; display: flex; gap: 10px; align-items: flex-start;"><i data-lucide="chevron-right" style="color: var(--o); flex-shrink: 0; width: 18px; margin-top: 3px;"></i> Basic Human Anatomy &amp; Physiology</li>
                <li style="margin-bottom: 12px; display: flex; gap: 10px; align-items: flex-start;"><i data-lucide="chevron-right" style="color: var(--o); flex-shrink: 0; width: 18px; margin-top: 3px;"></i> Nutrition &amp; Hygiene in Community Health</li>
                <li style="margin-bottom: 12px; display: flex; gap: 10px; align-items: flex-start;"><i data-lucide="chevron-right" style="color: var(--o); flex-shrink: 0; width: 18px; margin-top: 3px;"></i> Introduction to Community Health Promotion</li>
                <li style="margin-bottom: 12px; display: flex; gap: 10px; align-items: flex-start;"><i data-lucide="chevron-right" style="color: var(--o); flex-shrink: 0; width: 18px; margin-top: 3px;"></i> Maternal &amp; Child Health Support</li>
                <li style="margin-bottom: 12px; display: flex; gap: 10px; align-items: flex-start;"><i data-lucide="chevron-right" style="color: var(--o); flex-shrink: 0; width: 18px; margin-top: 3px;"></i> Basics of Community Health Information Systems</li>
                <li style="margin-bottom: 12px; display: flex; gap: 10px; align-items: flex-start;"><i data-lucide="chevron-right" style="color: var(--o); flex-shrink: 0; width: 18px; margin-top: 3px;"></i> Environmental Health &amp; Sanitation</li>
                <li style="margin-bottom: 12px; display: flex; gap: 10px; align-items: flex-start;"><i data-lucide="chevron-right" style="color: var(--o); flex-shrink: 0; width: 18px; margin-top: 3px;"></i> First Aid &amp; Basic Care Support</li>
                <li style="margin-bottom: 12px; display: flex; gap: 10px; align-items: flex-start;"><i data-lucide="chevron-right" style="color: var(--o); flex-shrink: 0; width: 18px; margin-top: 3px;"></i> Gender, Disability &amp; Vulnerable Groups</li>
              </ul>
            </div>
          </section>

          <section class="course-description" style="margin-top: 10px;">
            <h2 class="course-sec-title">Industrial Attachment</h2>
            <p>Learners undertake a two (2) month hospital attachment in:</p>
            <ul style="list-style: none; padding: 0; margin-top: 8px; display: flex; flex-wrap: wrap; gap: 20px;">
              <li style="display: flex; gap: 10px;"><i data-lucide="hospital" style="color: var(--o);"></i> Accredited hospitals</li>
              <li style="display: flex; gap: 10px;"><i data-lucide="users" style="color: var(--o);"></i> Community units</li>
              <li style="display: flex; gap: 10px;"><i data-lucide="heart-handshake" style="color: var(--o);"></i> NGOs</li>
              <li style="display: flex; gap: 10px;"><i data-lucide="building-2" style="color: var(--o);"></i> County health departments</li>
            </ul>
            <p style="margin-top: 8px;">GoCare provides full placement support to ensure practical, real-world experience.</p>
          </section>

          <section class="course-description" style="margin-top: 14px; border-top: 1px solid #e2e8f0; padding-top: 16px;">
            <h2 class="course-sec-title">Career Opportunities</h2>
            <p>Graduates of the Certificate in Community Based Services – Level 4 can work in:</p>
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-top: 10px;">
              <ul style="list-style: none; padding: 0;">
                <li style="margin-bottom: 10px; display: flex; gap: 10px;"><i data-lucide="check" style="color: var(--o); flex-shrink: 0;"></i> Community health units</li>
                <li style="margin-bottom: 10px; display: flex; gap: 10px;"><i data-lucide="check" style="color: var(--o); flex-shrink: 0;"></i> Hospitals &amp; medical centres</li>
                <li style="margin-bottom: 10px; display: flex; gap: 10px;"><i data-lucide="check" style="color: var(--o); flex-shrink: 0;"></i> NGOs &amp; public health projects</li>
              </ul>
              <ul style="list-style: none; padding: 0;">
                <li style="margin-bottom: 10px; display: flex; gap: 10px;"><i data-lucide="check" style="color: var(--o); flex-shrink: 0;"></i> County health departments</li>
                <li style="margin-bottom: 10px; display: flex; gap: 10px;"><i data-lucide="check" style="color: var(--o); flex-shrink: 0;"></i> Household &amp; community care programs</li>
              </ul>
            </div>
            <p style="margin-top: 16px; font-weight: 600; color: var(--dark);">Job Roles Include:</p>
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-top: 8px;">
              <ul style="list-style: none; padding: 0;">
                <li style="margin-bottom: 10px; display: flex; gap: 10px;"><i data-lucide="check" style="color: var(--o); flex-shrink: 0;"></i> Community Health Support Worker</li>
                <li style="margin-bottom: 10px; display: flex; gap: 10px;"><i data-lucide="check" style="color: var(--o); flex-shrink: 0;"></i> Health Promotion Assistant</li>
                <li style="margin-bottom: 10px; display: flex; gap: 10px;"><i data-lucide="check" style="color: var(--o); flex-shrink: 0;"></i> Community Outreach Support Worker</li>
              </ul>
              <ul style="list-style: none; padding: 0;">
                <li style="margin-bottom: 10px; display: flex; gap: 10px;"><i data-lucide="check" style="color: var(--o); flex-shrink: 0;"></i> Maternal &amp; Child Health Aide</li>
                <li style="margin-bottom: 10px; display: flex; gap: 10px;"><i data-lucide="check" style="color: var(--o); flex-shrink: 0;"></i> Public Health Volunteer</li>
              </ul>
            </div>
            <p style="margin-top: 8px; font-weight: 500; color: var(--dark);">This qualification opens doors to a wide range of entry-level community health support roles and provides a clear pathway to higher qualifications.</p>
          </section>

          <section class="course-description" style="margin-top: 14px; border-top: 1px solid #e2e8f0; padding-top: 16px;">
            <h2 class="course-sec-title">How to Enrol</h2>
            <div style="display: grid; gap: 12px;">
              <div style="display: flex; gap: 15px; align-items: flex-start;">
                <div style="background: var(--o); color: #F5F0E8; width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-weight: bold;">1</div>
                <p style="margin: 0;"><strong>Option 1:</strong> Apply Online via the GoCare Application Form</p>
              </div>
              <div style="display: flex; gap: 15px; align-items: flex-start;">
                <div style="background: var(--o); color: #F5F0E8; width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-weight: bold;">2</div>
                <p style="margin: 0;"><strong>Option 2:</strong> Visit Any Campus for Guided Registration</p>
              </div>
            </div>
            <p style="margin-top: 12px;">Admissions Line: <a href="tel:+254703115502" style="color: var(--o); font-weight: 600;">0703 115 502</a></p>
          </section>
        </div>

        <aside class="course-sidebar">
          <div class="sidebar-card" style="background: #fcfcfc; padding: 20px; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.05); margin-bottom: 30px; border-top: 5px solid var(--o);">
            <div class="sidebar-duration-box" style="background: linear-gradient(135deg, #fff7ed, #fdf1e4); border: 1px solid #fbdcb5; border-radius: 12px; padding: 22px 24px; margin-bottom: 22px; text-align: center;">
              ...
              <!--<p style="margin: 8px 0 0; font-size: 13px; color: var(--gray);">8 Months Tuition + 2 Months Attachment</p>-->
            </div>
            ...
            <div class="sidebar-info-list" style="margin-top: 10px;">
              ...
              <div class="side-info-item" style="padding: 12px 0; border-bottom: 1px dashed #e2e8f0;">
                <span style="color: var(--gray); font-size: 13px; display: block; margin-bottom: 4px;">External Assessment / Examination Body</span>
              ...
              <div class="side-info-item" style="padding: 12px 0;">
                ...
                <strong style="color: var(--dark); display: block; font-size: 14px; line-height: 1.4;">TVET CDACC Certificate<br>GoCare Completion Certificate<br>Academic Transcripts</strong>
              </div>
            </div>
          </div>
          ...
          <div class="help-card" style="background: var(--dark); color: #F5F0E8; padding: 30px; border-radius: 12px; text-align: center; position: relative; overflow: hidden;">
            ...
            <h4 style="color: #F5F0E8; margin-bottom: 10px; position: relative; z-index: 2;">Begin Your Community Health Journey Today</h4>
            <p style="color: rgba(255,255,255,0.8); margin-bottom: 20px; font-size: 14px; position: relative; z-index: 2;">Start at Level 4, build strong foundational skills, and progress confidently into Level 5 and Level 6 to become a fully licensed Community Health Assistant.</p>
