...
<head>
  ...
  <title>Admissions Support | Admissions | GoCare Training Institute</title>
...
<style>
  ...
  @media (max-width: 768px) {
    ...
    .btn-sc-submit, .btn-sc-outline { padding: 14px 32px; font-size: 1rem; width: 100%; }
  }
  @media (max-width: 480px) {
    .sc-hero-copy h1 { font-size: 1.9rem; }
    .sc-hero-copy p { font-size: .95rem; }
    .adm-content-box { padding: 24px 16px; }
    .adm-sec-title { font-size: 1.5rem; }
    .adm-info-card { padding: 20px 16px; }
    .adm-info-card h4 { font-size: 1.05rem; }
    .adm-info-card p { font-size: .88rem; }
    .btn-sc-submit, .btn-sc-outline { padding: 12px 24px; font-size: .9rem; }
  }
  .as-strip { display:grid; grid-template-columns:1fr 1fr 1fr; height:260px; gap:6px; }
  .as-strip img { width:100%; height:100%; object-fit:cover; display:block; }
  .as-split { display:grid; grid-template-columns:1fr 1fr; border-radius:16px; overflow:hidden; border:1px solid #e2e8f0; margin:40px 0; }
  .as-split-img img { width:100%; height:100%; object-fit:cover; min-height:280px; display:block; }
  .as-split-body { padding:36px 32px; display:flex; flex-direction:column; justify-content:center; background:#fcf9f8; }
  .as-split-body h3 { font-size:1.3rem; font-weight:800; color:#4a1a6d; margin-bottom:12px; }
  .as-split-body p { font-size:.95rem; color:#475569; line-height:1.7; }
  @media(max-width:768px){ .as-strip{grid-template-columns:1fr 1fr;height:180px;} .as-strip img:last-child{display:none;} .as-split{grid-template-columns:1fr;} }
</style>
...
<div class="adm-page">
  ...
  <section class="ph ph--split">
    <div class="ph-bg">
      <img loading="eager" decoding="async" src="../images/female-nurse-portrait-with-older-patient.jpg" alt="Admissions Support">
    </div>
    <div class="ph-overlay"></div>
    <div class="ph-inner">
      <div class="ph-content">
        <span class="ph-eyebrow"><i data-lucide="headphones"></i> Admissions Support</span>
        <nav class="ph-breadcrumb" aria-label="Breadcrumb">
          <a href="../index">Home</a><i data-lucide="chevron-right"></i><a href="../admissions#overview">Admissions</a><i data-lucide="chevron-right"></i><span>Support</span>
        </nav>
        <h1>Admissions <em>Support</em></h1>
        <p>Our dedicated admissions team is here to help you at every step &ndash; from choosing the right course to completing your enrolment.</p>
        <div class="ph-btns">
      ...
      <div class="ph-form-card">
        ...
        <div class="ph-form-group">
          ...
          <select class="ph-form-input">
            ...
            <option>Entry Requirements</option>
            <option>Intake Dates</option>
            <option>Other</option>
          </select>
        </div>
        <button class="ph-form-submit" onclick="window.location='../contact.html'">Send Enquiry &rarr;</button>
      </div>
    </div>
  </section>
  ...
  <section class="adm-sec">
    <div class="adm-wrap">
        ...
        <div class="adm-content-box">
          <h2><i data-lucide="phone-call"></i> Contact the Team</h2>
          <p>If you have any questions regarding your application, entry requirements, or the portal, please reach out to us:</p>
          <ul class="adm-list-rich"><li><i data-lucide="check-circle-2"></i> <div><strong>24/7 WhatsApp Helpdesk:</strong> Instant chat support available for rapid responses.</div></li><li><i data-lucide="check-circle-2"></i> <div><strong>Email Support:</strong> Email us at admissions@gocare.ac.ke for detailed inquiries.</div></li><li><i data-lucide="check-circle-2"></i> <div><strong>Campus Visit:</strong> Visit our main campus during working hours (8:00 AM - 5:00 PM) for in-person guidance.</div></li></ul>
        </div>
