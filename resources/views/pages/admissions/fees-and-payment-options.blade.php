...
<head>
  ...
  <title>Fees & Payment Options | Admissions | GoCare Training Institute</title>
...
<style>
  ...
  .fee-photo-strip { display:grid; grid-template-columns:1fr 1fr 1fr; height:260px; gap:6px; }
  .fee-photo-strip img { width:100%; height:100%; object-fit:cover; display:block; }
  .fee-split { display:grid; grid-template-columns:1fr 1fr; border-radius:16px; overflow:hidden; border:1px solid #e2e8f0; margin:40px 0; }
  .fee-split-img { overflow:hidden; min-height:280px; }
  .fee-split-img img { width:100%; height:100%; object-fit:cover; }
  .fee-split-body { padding:36px 32px; display:flex; flex-direction:column; justify-content:center; background:#fcf9f8; }
  .fee-split-body h3 { font-size:1.3rem; font-weight:800; color:#4a1a6d; margin-bottom:12px; }
  .fee-split-body p { font-size:.95rem; color:#475569; line-height:1.7; }
  @media(max-width:768px){ .fee-photo-strip{grid-template-columns:1fr 1fr;height:180px;} .fee-photo-strip img:last-child{display:none;} .fee-split{grid-template-columns:1fr;} .fee-split-img{min-height:220px;} }
</style>
...
<div class="adm-page">
  ...
  <section class="ph">
    <div class="ph-bg">
      <img loading="eager" decoding="async" src="../images/new-images/DSC05878.jpg" alt="Fees & Payments">
    </div>
    <div class="ph-overlay"></div>
    <div class="ph-inner">
      <div class="ph-content">
        <span class="ph-eyebrow"><i data-lucide="wallet"></i> Fees & Payments</span>
        <nav class="ph-breadcrumb" aria-label="Breadcrumb">
          <a href="../index">Home</a><i data-lucide="chevron-right"></i><a href="../admissions#overview">Admissions</a><i data-lucide="chevron-right"></i><span>Fees & Payment</span>
        </nav>
        <h1>Fees & <em>Payment Options</em></h1>
        <p>Transparent, affordable fee structures with flexible payment plans, HELB support, and sponsorship options available. Investing in your future starts here.</p>
        <div class="ph-btns">
          <a href="../apply" class="ph-btn-primary">Apply Now <i data-lucide="arrow-right"></i></a>
          <a href="../admissions#support" class="ph-btn-ghost">Payment Help <i data-lucide="arrow-right"></i></a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="adm-sec">
    <div class="adm-wrap">
        ...
        <div class="adm-content-box">
          <h2><i data-lucide="coins"></i> Tuition Overview</h2>
          <p>We believe in providing affordable, high-quality education. Detailed fee structures are provided with your admission letter, as costs vary by program (e.g., Medical Sciences vs. Hospitality).</p>
          
        </div>
        
        <div class="adm-content-box">
          <h2><i data-lucide="credit-card"></i> Payment Options & Aid</h2>
          <p>To ensure education is accessible, we support multiple financing options:</p>
          <ul class="adm-list-rich"><li><i data-lucide="check-circle-2"></i> <div><strong>HELB Loans:</strong> We are fully accredited, meaning our students are eligible for Higher Education Loans Board (HELB) financing.</div></li><li><i data-lucide="check-circle-2"></i> <div><strong>Installment Plans:</strong> Tuition can be paid in flexible monthly or termly installments.</div></li><li><i data-lucide="check-circle-2"></i> <div><strong>Bank Transfers & M-Pesa:</strong> Secure direct payments to the Institute's official bank accounts or Paybill numbers.</div></li></ul>
        </div>
