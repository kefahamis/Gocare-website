...
<head>
  ...
  <title>Application Form - Step 2: Education Background | GoCare Training Institute</title>
...
<body>
  ...
  <style>
    ...
    .app-hero { background: linear-gradient(135deg, rgba(74,26,109,0.95), rgba(100,42,126,0.85)), url('images/Healthcare-professional.jpg'); background-size: cover; background-position: center; padding: 50px 0 40px; margin-bottom: 50px; }
    ...
    .app-footer-nav { display: flex; justify-content: space-between; align-items: center; margin-top: 40px; }
  ...
  <main class="app-page">
    <div class="app-hero">
      <div class="app-hero-inner">
        ...
        <p>Step 2 of 6 &mdash; Education Background</p>
      </div>
    </div>
    ...
    <div class="app-wrap">
      <div class="stepper">
        ...
        <div class="step-item"><div class="step-col"><div class="step-circle active">2</div><div class="step-label active-label">Education</div></div></div>
        <div class="step-line active"></div>
        <div class="step-item"><div class="step-col"><div class="step-circle pending">3</div><div class="step-label pending-label">Course Selection</div></div></div>
      ...
      <div class="app-grid">
          ...
          <form id="step2Form">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input type="text" placeholder="e.g. Alliance High School" required>
              </div>
              <div class="form-group">
                <label>Year of Completion *</label>
                <select required>
                  <option value="">Select Year</option>
                  <option>2025</option><option>2024</option><option>2023</option><option>2022</option><option>2021</option><option>2020</option><option>2019</option><option>Earlier</option>
                </select>
              </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-group">
              ...
              <textarea rows="3" placeholder="List any additional certificates, diplomas, or professional qualifications..."></textarea>
            </div>
            <div class="form-actions">
              <a href="application-form" class="btn-prev"><i data-lucide="arrow-left" style="width:18px;height:18px;display:inline;vertical-align:middle"></i> Previous</a>
              <button type="button" class="btn-next" onclick="window.location.href='application-form-step3'">Save &amp; Continue <i data-lucide="arrow-right" style="width:18px;height:18px;display:inline;vertical-align:middle"></i></button>
            </div>
          </form>
        </div>
        ...
        <div style="display:flex;flex-direction:column;gap:24px;">
          <div class="sidebar-tips">
            <h3><i data-lucide="lightbulb"></i> Education Tips</h3>
            <ul>
              <li><i data-lucide="check-circle-2"></i> Enter your highest completed qualification.</li>
              <li><i data-lucide="check-circle-2"></i> KCSE C+ and above qualify for diploma programs.</li>
              <li><i data-lucide="check-circle-2"></i> KCSE C- to D+ qualify for certificate programs.</li>
            </ul>
          </div>
          <div class="sidebar-card">
            <img loading="lazy" decoding="async" src="images/Certificate-culinary-arts.jpg" alt="Students in class">
            <div class="sidebar-body">
              <h3>Entry Requirements</h3>
              <p>Check if you qualify for your desired program:</p>
              <ul>
                <li><i data-lucide="award"></i> Diploma: KCSE C+ or above</li>
                <li><i data-lucide="award"></i> Certificate: KCSE C- to D+</li>
                <li><i data-lucide="award"></i> Artisan: KCSE D or below</li>
              </ul>
              <a href="admissions#requirements" class="btn-next" style="display:block;text-align:center;margin-top:16px;text-decoration:none;font-size:0.9rem;">View Full Requirements</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="app-footer-nav">
        <div></div>
        <a href="admissions#how-to-apply" class="btn-prev">View How to Apply Guide <i data-lucide="external-link" style="width:18px;height:18px;display:inline;vertical-align:middle"></i></a>
      </div>
    </div>
  </main>
