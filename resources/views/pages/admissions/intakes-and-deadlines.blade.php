...
<head>
  ...
  <title>Intakes & Deadlines | Admissions | GoCare Training Institute</title>
...
<style>
  ...
  .id-hero-content h1 em { font-style: italic; color: #fff; }
  .id-hero-content h1 span { color: var(--o); font-style: italic; }
  .id-hero-content .id-sub {
    font-size: 1.15rem;
    line-height: 1.7;
  ...
  .id-btn-primary:hover { transform: translateY(-2px); box-shadow: 0 12px 28px rgba(236,116,36,0.55); color: #fff; }
  .id-btn-secondary {
    background: var(--dark);
    color: #fff;
    padding: 14px 34px;
  ...
  .id-btn-secondary:hover { transform: translateY(-2px); box-shadow: 0 12px 28px rgba(74,26,109,0.55); color: #fff; }
  ...
  .id-info-block p:last-child { border-bottom: none; padding-bottom: 0; }
  ...
  .id-footer-bar .id-tagline { font-size: 1.1rem; font-weight: 700; letter-spacing: 0.5px; }
  .id-footer-bar .id-tagline span { color: var(--o); }
  .id-footer-bar-btns { display: flex; gap: 12px; flex-wrap: wrap; }
  .id-footer-bar-btns a { padding: 10px 24px; border-radius: 6px; font-weight: 700; font-size: 0.95rem; text-decoration: none; transition: 0.2s; }
  .id-fbar-orange { background: var(--o); color: #fff; }
  .id-fbar-orange:hover { background: #d4611a; color: #fff; }
  .id-fbar-purple { background: rgba(255,255,255,0.15); color: #fff; border: 1px solid rgba(255,255,255,0.3); }
  .id-fbar-purple:hover { background: rgba(255,255,255,0.25); color: #fff; }

  @media (max-width: 768px) {
    .id-hero-inner { padding: 100px 20px 60px; }
    .id-hero-content { max-width: 100%; }
    .id-footer-bar { flex-direction: column; text-align: center; }
  }
</style>
  ...
  <section class="ph">
    <div class="ph-bg">
      <img loading="eager" decoding="async" src="../images/new-images/DSC05884.jpg" alt="Intakes & Deadlines">
    </div>
    <div class="ph-overlay"></div>
    <div class="ph-inner">
      <div class="ph-content">
        <span class="ph-eyebrow"><i data-lucide="calendar"></i> Intakes & Deadlines</span>
        <nav class="ph-breadcrumb" aria-label="Breadcrumb">
          <a href="../index">Home</a><i data-lucide="chevron-right"></i><a href="../admissions#overview">Admissions</a><i data-lucide="chevron-right"></i><span>Intakes & Deadlines</span>
        </nav>
        <h1>Intakes & <em>Deadlines</em></h1>
        <p>GoCare runs multiple intakes per year. Check upcoming intake dates and application deadlines to plan your enrolment with confidence.</p>
        <div class="ph-btns">
          <a href="../apply" class="ph-btn-primary">Apply Now <i data-lucide="arrow-right"></i></a>
          <a href="../admissions#support" class="ph-btn-ghost">Get Help <i data-lucide="arrow-right"></i></a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="adm-sec">
    <div class="adm-wrap">
        ...
        <div class="adm-content-box">
          <h2><i data-lucide="calendar-check"></i> Major Intakes</h2>
          <p>GoCare Training Institute offers three major intakes annually to ensure flexibility for our prospective students:</p>
          <ul class="adm-list-rich"><li><i data-lucide="check-circle-2"></i> <div><strong>January Intake:</strong> Applications close on December 15th.</div></li><li><i data-lucide="check-circle-2"></i> <div><strong>May Intake:</strong> Applications close on April 15th.</div></li><li><i data-lucide="check-circle-2"></i> <div><strong>September Intake:</strong> Applications close on August 15th.</div></li></ul>
        </div>
        
        <div class="adm-content-box">
          <h2><i data-lucide="users"></i> Orientation Dates</h2>
          <p>All new students are required to attend orientation. Exact dates will be communicated via your admission letter, but generally occur one week before classes commence.</p>
