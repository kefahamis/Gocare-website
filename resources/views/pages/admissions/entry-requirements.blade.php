...
<head>
  ...
  <title>Entry Requirements | Admissions | GoCare Training Institute</title>
...
<style>
  ...
  .er-hero-overlay {
    ...
    inset: 0;
    z-index: 1;
    background: linear-gradient(to right, rgba(10,10,10,0.90) 0%, rgba(10,10,10,0.60) 42%, transparent 72%);
  }
  .er-hero-inner {
    position: relative;
    z-index: 2;
  ...
  .er-hero-content h1 em {
    font-style: italic;
    color: #fff;
  }
  .er-hero-content h1 span {
    color: var(--o);
    font-style: italic;
  }
  .er-hero-content .er-sub {
    font-size: 1.2rem;
    line-height: 1.7;
  ...
  .er-btn-primary:hover { transform: translateY(-2px); box-shadow: 0 12px 28px rgba(236,116,36,0.55); color: #fff; }
  .er-btn-secondary {
    background: var(--dark);
    color: #fff;
    padding: 15px 36px;
    ...
    letter-spacing: 0.5px;
    transition: 0.25s;
    box-shadow: 0 8px 20px rgba(74,26,109,0.4);
    display: inline-block;
  }
  .er-btn-secondary:hover { transform: translateY(-2px); box-shadow: 0 12px 28px rgba(74,26,109,0.55); color: #fff; }
  ...
  /* -- BOTTOM BAR -- */
  .er-footer-bar {
    background: linear-gradient(90deg, var(--dark) 0%, #7b2d8b 50%, var(--dark) 100%);
    color: #fff;
    padding: 18px 40px;
    display: flex;
    align-items: center;
  ...
  .er-footer-bar .er-tagline {
    font-size: 1.1rem;
    font-weight: 700;
    letter-spacing: 0.5px;
  }
  .er-footer-bar .er-tagline span { color: var(--o); }
  .er-footer-bar-btns {
    display: flex;
    gap: 12px;
    flex-wrap: wrap;
  }
  .er-footer-bar-btns a {
    padding: 10px 24px;
    border-radius: 6px;
    font-weight: 700;
    font-size: 0.95rem;
  ...
  .er-fbar-orange { background: var(--o); color: #fff; }
  .er-fbar-orange:hover { background: #d4611a; color: #fff; }
  .er-fbar-purple { background: rgba(255,255,255,0.15); color: #fff; border: 1px solid rgba(255,255,255,0.3); }
  .er-fbar-purple:hover { background: rgba(255,255,255,0.25); color: #fff; }

  @media (max-width: 768px) {
    .er-hero-inner { padding: 100px 20px 60px; }
    .er-hero-content { max-width: 100%; }
    .er-info-card { max-width: 100%; }
    .er-footer-bar { flex-direction: column; text-align: center; }
  }
</style>
  ...
  <section class="ph">
    <div class="ph-bg">
      <img loading="eager" decoding="async" src="../images/gocare-students-group.jpg" alt="Entry Requirements">
    </div>
    <div class="ph-overlay"></div>
    <div class="ph-inner">
      <div class="ph-content">
        <span class="ph-eyebrow"><i data-lucide="clipboard-list"></i> Entry Requirements</span>
        <nav class="ph-breadcrumb" aria-label="Breadcrumb">
          <a href="../index">Home</a><i data-lucide="chevron-right"></i><a href="../admissions#overview">Admissions</a><i data-lucide="chevron-right"></i><span>Entry Requirements</span>
        </nav>
        <h1>Entry <em>Requirements</em></h1>
        <p>Find the minimum qualifications needed for each programme &ndash; from certificate to diploma level. GoCare welcomes learners from diverse academic backgrounds.</p>
        <div class="ph-btns">
          <a href="../apply" class="ph-btn-primary">Apply Now <i data-lucide="arrow-right"></i></a>
          <a href="../admissions#support" class="ph-btn-ghost">Ask Admissions <i data-lucide="arrow-right"></i></a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="adm-sec">
    <div class="adm-wrap">
        ...
        <div class="adm-content-box">
          <h2><i data-lucide="file-text"></i> General Requirements</h2>
          <p>All applicants must provide standard documentation regardless of the program level:</p>
          <ul class="adm-list-rich"><li><i data-lucide="check-circle-2"></i> <div><strong>Identification:</strong> A valid National ID card or Passport.</div></li><li><i data-lucide="check-circle-2"></i> <div><strong>Photographs:</strong> Two recent passport-sized photographs.</div></li><li><i data-lucide="check-circle-2"></i> <div><strong>Academic Records:</strong> Certified copies of your KCSE/KSCE certificate or equivalent.</div></li></ul>
        </div>
        
        <div class="adm-content-box">
          <h2><i data-lucide="graduation-cap"></i> Program-Specific Criteria</h2>
          <p>Different academic levels have varying minimum grade requirements:</p>
          <ul class="adm-list-rich"><li><i data-lucide="check-circle-2"></i> <div><strong>Diploma Programs:</strong> Minimum KCSE Mean Grade of C- (Minus) or a relevant Certificate qualification.</div></li><li><i data-lucide="check-circle-2"></i> <div><strong>Certificate Programs:</strong> Minimum KCSE Mean Grade of D (Plain) or D+ (Plus) depending on the course.</div></li><li><i data-lucide="check-circle-2"></i> <div><strong>Artisan / Short Courses:</strong> Open to KCSE graduates (any grade) or relevant prior experience.</div></li></ul>
        </div>
